 ...
 */
#ifndef XETRA_DELETEALLQUOTEREQUEST_PACKET_H
#define XETRA_DELETEALLQUOTEREQUEST_PACKET_H
...
class xetraDeleteAllQuoteRequestPacket
{
    public:
        // no value constants
        ...
        // constructor
        xetraDeleteAllQuoteRequestPacket ()
        {
...
const uint64_t xetraDeleteAllQuoteRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_MIN = 0UL;
const uint64_t xetraDeleteAllQuoteRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_MAX = 18446744073709551614UL;
const uint64_t xetraDeleteAllQuoteRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t xetraDeleteAllQuoteRequestPacket::EXECUTING_TRADER_MIN = 0UL;
const uint64_t xetraDeleteAllQuoteRequestPacket::EXECUTING_TRADER_MAX = 18446744073709551614UL;
const uint64_t xetraDeleteAllQuoteRequestPacket::EXECUTING_TRADER_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const int32_t xetraDeleteAllQuoteRequestPacket::MARKET_SEGMENT_ID_MIN = -2147483647;
const int32_t xetraDeleteAllQuoteRequestPacket::MARKET_SEGMENT_ID_MAX = 2147483647;
const int32_t xetraDeleteAllQuoteRequestPacket::MARKET_SEGMENT_ID_NO_VALUE = 0x80000000;
const uint32_t xetraDeleteAllQuoteRequestPacket::TARGET_PARTY_IDSESSION_ID_MIN = 0;
const uint32_t xetraDeleteAllQuoteRequestPacket::TARGET_PARTY_IDSESSION_ID_MAX = 4294967294;
const uint32_t xetraDeleteAllQuoteRequestPacket::TARGET_PARTY_IDSESSION_ID_NO_VALUE = 0xFFFFFFFF;
const int8_t xetraDeleteAllQuoteRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_MIN = 22;
const int8_t xetraDeleteAllQuoteRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_MAX = 24;
const int8_t xetraDeleteAllQuoteRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_NO_VALUE = 0xFF;
const int8_t xetraDeleteAllQuoteRequestPacket::EXECUTING_TRADER_QUALIFIER_MIN = 22;
const int8_t xetraDeleteAllQuoteRequestPacket::EXECUTING_TRADER_QUALIFIER_MAX = 24;
const int8_t xetraDeleteAllQuoteRequestPacket::EXECUTING_TRADER_QUALIFIER_NO_VALUE = 0xFF;
const char xetraDeleteAllQuoteRequestPacket::PAD6_NO_VALUE[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraDeleteAllQuoteRequestPacket::PAD6_MAX_LENGTH = 6;


} // namespace neueda

#endif // XETRA_DELETEALLQUOTEREQUEST_PACKET_H
