 ...
 */
#ifndef XETRA_TESDELETEBROADCAST_PACKET_H
#define XETRA_TESDELETEBROADCAST_PACKET_H
...
class xetraTESDeleteBroadcastPacket
{
    public:
        // no value constants
        ...
        codecState serialize (void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = xetra::serialize (mDeleteReason, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        codecState deserialize (const void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = xetra::deserialize (mDeleteReason, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
...
const uint64_t xetraTESDeleteBroadcastPacket::TRANSACT_TIME_MIN = 0UL;
const uint64_t xetraTESDeleteBroadcastPacket::TRANSACT_TIME_MAX = 18446744073709551614UL;
const uint64_t xetraTESDeleteBroadcastPacket::TRANSACT_TIME_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const int32_t xetraTESDeleteBroadcastPacket::MARKET_SEGMENT_ID_MIN = -2147483647;
const int32_t xetraTESDeleteBroadcastPacket::MARKET_SEGMENT_ID_MAX = 2147483647;
const int32_t xetraTESDeleteBroadcastPacket::MARKET_SEGMENT_ID_NO_VALUE = 0x80000000;
const uint32_t xetraTESDeleteBroadcastPacket::PACKAGE_ID_MIN = 0;
const uint32_t xetraTESDeleteBroadcastPacket::PACKAGE_ID_MAX = 4294967294;
const uint32_t xetraTESDeleteBroadcastPacket::PACKAGE_ID_NO_VALUE = 0xFFFFFFFF;
const uint32_t xetraTESDeleteBroadcastPacket::TESEXEC_ID_MIN = 0;
const uint32_t xetraTESDeleteBroadcastPacket::TESEXEC_ID_MAX = 4294967294;
const uint32_t xetraTESDeleteBroadcastPacket::TESEXEC_ID_NO_VALUE = 0xFFFFFFFF;
const int16_t xetraTESDeleteBroadcastPacket::TRD_TYPE_MIN = 1;
const int16_t xetraTESDeleteBroadcastPacket::TRD_TYPE_MAX = 1005;
const int16_t xetraTESDeleteBroadcastPacket::TRD_TYPE_NO_VALUE = 0xFFFF;
const int8_t xetraTESDeleteBroadcastPacket::DELETE_REASON_MIN = 100;
const int8_t xetraTESDeleteBroadcastPacket::DELETE_REASON_MAX = 107;
const int8_t xetraTESDeleteBroadcastPacket::DELETE_REASON_NO_VALUE = 0xFF;
const int8_t xetraTESDeleteBroadcastPacket::TRADE_REPORT_TYPE_MIN = 0;
const int8_t xetraTESDeleteBroadcastPacket::TRADE_REPORT_TYPE_MAX = 13;
const int8_t xetraTESDeleteBroadcastPacket::TRADE_REPORT_TYPE_NO_VALUE = 0xFF;
const char xetraTESDeleteBroadcastPacket::MESSAGE_EVENT_SOURCE_NO_VALUE[1] = {0x00};
const size_t xetraTESDeleteBroadcastPacket::MESSAGE_EVENT_SOURCE_MAX_LENGTH = 1;
const char xetraTESDeleteBroadcastPacket::TRADE_REPORT_ID_NO_VALUE[20] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraTESDeleteBroadcastPacket::TRADE_REPORT_ID_MAX_LENGTH = 20;
const char xetraTESDeleteBroadcastPacket::PAD3_NO_VALUE[3] = {0x00, 0x00, 0x00};
const size_t xetraTESDeleteBroadcastPacket::PAD3_MAX_LENGTH = 3;


} // namespace neueda

#endif // XETRA_TESDELETEBROADCAST_PACKET_H
