 ...
 */
#ifndef XETRA_DELETEALLQUOTERESPONSE_PACKET_H
#define XETRA_DELETEALLQUOTERESPONSE_PACKET_H
...
class xetraDeleteAllQuoteResponsePacket
{
    public:
        // no value constants
        ...
        // constructor
        xetraDeleteAllQuoteResponsePacket ()
        {
...
const uint64_t xetraDeleteAllQuoteResponsePacket::MASS_ACTION_REPORT_ID_MIN = 0UL;
const uint64_t xetraDeleteAllQuoteResponsePacket::MASS_ACTION_REPORT_ID_MAX = 18446744073709551614UL;
const uint64_t xetraDeleteAllQuoteResponsePacket::MASS_ACTION_REPORT_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const int16_t xetraDeleteAllQuoteResponsePacket::NO_NOT_AFFECTED_SECURITIES_MIN = 0;
const int16_t xetraDeleteAllQuoteResponsePacket::NO_NOT_AFFECTED_SECURITIES_MAX = 500;
const int16_t xetraDeleteAllQuoteResponsePacket::NO_NOT_AFFECTED_SECURITIES_NO_VALUE = 0xFFFF;
const char xetraDeleteAllQuoteResponsePacket::PAD6_NO_VALUE[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraDeleteAllQuoteResponsePacket::PAD6_MAX_LENGTH = 6;
const size_t xetraDeleteAllQuoteResponsePacket::NOT_AFFECTED_SECURITIES_GRP_MIN = 0;
const size_t xetraDeleteAllQuoteResponsePacket::NOT_AFFECTED_SECURITIES_GRP_MAX = 500;


} // namespace neueda

#endif // XETRA_DELETEALLQUOTERESPONSE_PACKET_H
