...
class xetraAffectedOrdGrpCompPacket
{
    public:
        ...
        {
            codecState state;
            state = xetra::serialize (mAffectedOrderID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = xetra::serialize (mAffectedOrigClOrdID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        {
            codecState state;
            state = xetra::deserialize (mAffectedOrderID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = xetra::deserialize (mAffectedOrigClOrdID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            return GW_CODEC_SUCCESS;
        }
