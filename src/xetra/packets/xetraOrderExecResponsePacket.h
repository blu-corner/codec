...
const int32_t xetraOrderExecResponsePacket::LEAVES_QTY_MIN = -2147483647;
const int32_t xetraOrderExecResponsePacket::LEAVES_QTY_MAX = 2147483647;
const int32_t xetraOrderExecResponsePacket::LEAVES_QTY_NO_VALUE = 0x80000000;
const int32_t xetraOrderExecResponsePacket::CUM_QTY_MIN = -2147483647;
const int32_t xetraOrderExecResponsePacket::CUM_QTY_MAX = 2147483647;
const int32_t xetraOrderExecResponsePacket::CUM_QTY_NO_VALUE = 0x80000000;
const int32_t xetraOrderExecResponsePacket::CXL_QTY_MIN = -2147483647;
const int32_t xetraOrderExecResponsePacket::CXL_QTY_MAX = 2147483647;
const int32_t xetraOrderExecResponsePacket::CXL_QTY_NO_VALUE = 0x80000000;
const int32_t xetraOrderExecResponsePacket::DISPLAY_QTY_MIN = -2147483647;
const int32_t xetraOrderExecResponsePacket::DISPLAY_QTY_MAX = 2147483647;
const int32_t xetraOrderExecResponsePacket::DISPLAY_QTY_NO_VALUE = 0x80000000;
const int16_t xetraOrderExecResponsePacket::EXEC_RESTATEMENT_REASON_MIN = 0;
const int16_t xetraOrderExecResponsePacket::EXEC_RESTATEMENT_REASON_MAX = 300;
...
const int8_t xetraOrderExecResponsePacket::MATCH_TYPE_MAX = 12;
