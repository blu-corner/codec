...
class xetraApproveTESTradeRequestPacket
{
    public:
        // no value constants
        ...
        // constructor
        xetraApproveTESTradeRequestPacket ()
        {
...
const uint64_t xetraApproveTESTradeRequestPacket::PARTY_IDCLIENT_ID_MIN = 0UL;
const uint64_t xetraApproveTESTradeRequestPacket::PARTY_IDCLIENT_ID_MAX = 18446744073709551614UL;
const uint64_t xetraApproveTESTradeRequestPacket::PARTY_IDCLIENT_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t xetraApproveTESTradeRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_MIN = 0UL;
const uint64_t xetraApproveTESTradeRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_MAX = 18446744073709551614UL;
const uint64_t xetraApproveTESTradeRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t xetraApproveTESTradeRequestPacket::EXECUTING_TRADER_MIN = 0UL;
const uint64_t xetraApproveTESTradeRequestPacket::EXECUTING_TRADER_MAX = 18446744073709551614UL;
const uint64_t xetraApproveTESTradeRequestPacket::EXECUTING_TRADER_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const double xetraApproveTESTradeRequestPacket::ALLOC_QTY_MIN = -922337203685477.5807;
const double xetraApproveTESTradeRequestPacket::ALLOC_QTY_MAX = 922337203685477.5807;
const int64_t xetraApproveTESTradeRequestPacket::ALLOC_QTY_NO_VALUE = 0x8000000000000000;
const uint32_t xetraApproveTESTradeRequestPacket::PACKAGE_ID_MIN = 0;
const uint32_t xetraApproveTESTradeRequestPacket::PACKAGE_ID_MAX = 4294967294;
const uint32_t xetraApproveTESTradeRequestPacket::PACKAGE_ID_NO_VALUE = 0xFFFFFFFF;
const uint32_t xetraApproveTESTradeRequestPacket::ALLOC_ID_MIN = 0;
const uint32_t xetraApproveTESTradeRequestPacket::ALLOC_ID_MAX = 4294967294;
const uint32_t xetraApproveTESTradeRequestPacket::ALLOC_ID_NO_VALUE = 0xFFFFFFFF;
const uint32_t xetraApproveTESTradeRequestPacket::TESEXEC_ID_MIN = 0;
const uint32_t xetraApproveTESTradeRequestPacket::TESEXEC_ID_MAX = 4294967294;
const uint32_t xetraApproveTESTradeRequestPacket::TESEXEC_ID_NO_VALUE = 0xFFFFFFFF;
const int32_t xetraApproveTESTradeRequestPacket::MARKET_SEGMENT_ID_MIN = -2147483647;
...
const int8_t xetraApproveTESTradeRequestPacket::TRADING_CAPACITY_NO_VALUE = 0xFF;
const int8_t xetraApproveTESTradeRequestPacket::TRADE_REPORT_TYPE_MIN = 0;
const int8_t xetraApproveTESTradeRequestPacket::TRADE_REPORT_TYPE_MAX = 13;
const int8_t xetraApproveTESTradeRequestPacket::TRADE_REPORT_TYPE_NO_VALUE = 0xFF;
const int8_t xetraApproveTESTradeRequestPacket::SIDE_MIN = 1;
const int8_t xetraApproveTESTradeRequestPacket::SIDE_MAX = 2;
const int8_t xetraApproveTESTradeRequestPacket::SIDE_NO_VALUE = 0xFF;
const int8_t xetraApproveTESTradeRequestPacket::VALUE_CHECK_TYPE_VALUE_MIN = 0;
const int8_t xetraApproveTESTradeRequestPacket::VALUE_CHECK_TYPE_VALUE_MAX = 1;
const int8_t xetraApproveTESTradeRequestPacket::VALUE_CHECK_TYPE_VALUE_NO_VALUE = 0xFF;
const int8_t xetraApproveTESTradeRequestPacket::VALUE_CHECK_TYPE_QUANTITY_MIN = 0;
const int8_t xetraApproveTESTradeRequestPacket::VALUE_CHECK_TYPE_QUANTITY_MAX = 1;
const int8_t xetraApproveTESTradeRequestPacket::VALUE_CHECK_TYPE_QUANTITY_NO_VALUE = 0xFF;
const int8_t xetraApproveTESTradeRequestPacket::ORDER_ATTRIBUTE_LIQUIDITY_PROVISION_MIN = 0;
const int8_t xetraApproveTESTradeRequestPacket::ORDER_ATTRIBUTE_LIQUIDITY_PROVISION_MAX = 1;
const int8_t xetraApproveTESTradeRequestPacket::ORDER_ATTRIBUTE_LIQUIDITY_PROVISION_NO_VALUE = 0xFF;
const int8_t xetraApproveTESTradeRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_MIN = 22;
const int8_t xetraApproveTESTradeRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_MAX = 24;
const int8_t xetraApproveTESTradeRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_NO_VALUE = 0xFF;
const int8_t xetraApproveTESTradeRequestPacket::EXECUTING_TRADER_QUALIFIER_MIN = 22;
const int8_t xetraApproveTESTradeRequestPacket::EXECUTING_TRADER_QUALIFIER_MAX = 24;
const int8_t xetraApproveTESTradeRequestPacket::EXECUTING_TRADER_QUALIFIER_NO_VALUE = 0xFF;
const char xetraApproveTESTradeRequestPacket::TRADE_REPORT_ID_NO_VALUE[20] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraApproveTESTradeRequestPacket::TRADE_REPORT_ID_MAX_LENGTH = 20;
const char xetraApproveTESTradeRequestPacket::PARTY_EXECUTING_FIRM_NO_VALUE[5] = {0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraApproveTESTradeRequestPacket::PARTY_EXECUTING_FIRM_MAX_LENGTH = 5;
const char xetraApproveTESTradeRequestPacket::PARTY_EXECUTING_TRADER_NO_VALUE[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraApproveTESTradeRequestPacket::PARTY_EXECUTING_TRADER_MAX_LENGTH = 6;
const char xetraApproveTESTradeRequestPacket::FREE_TEXT1_NO_VALUE[12] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraApproveTESTradeRequestPacket::FREE_TEXT1_MAX_LENGTH = 12;
const char xetraApproveTESTradeRequestPacket::FREE_TEXT2_NO_VALUE[12] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraApproveTESTradeRequestPacket::FREE_TEXT2_MAX_LENGTH = 12;
const char xetraApproveTESTradeRequestPacket::FREE_TEXT4_NO_VALUE[16] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraApproveTESTradeRequestPacket::FREE_TEXT4_MAX_LENGTH = 16;
const char xetraApproveTESTradeRequestPacket::PAD7_NO_VALUE[7] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraApproveTESTradeRequestPacket::PAD7_MAX_LENGTH = 7;


} // namespace neueda

#endif // XETRA_APPROVETESTRADEREQUEST_PACKET_H
