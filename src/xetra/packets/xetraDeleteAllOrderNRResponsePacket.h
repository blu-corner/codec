 ...
 */
#ifndef XETRA_DELETEALLORDERNRRESPONSE_PACKET_H
#define XETRA_DELETEALLORDERNRRESPONSE_PACKET_H
...
class xetraDeleteAllOrderNRResponsePacket
{
    public:
        // no value constants
        ...
        // constructor
        xetraDeleteAllOrderNRResponsePacket ()
        {
...
const uint64_t xetraDeleteAllOrderNRResponsePacket::MASS_ACTION_REPORT_ID_MIN = 0UL;
const uint64_t xetraDeleteAllOrderNRResponsePacket::MASS_ACTION_REPORT_ID_MAX = 18446744073709551614UL;
const uint64_t xetraDeleteAllOrderNRResponsePacket::MASS_ACTION_REPORT_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;


} // namespace neueda

#endif // XETRA_DELETEALLORDERNRRESPONSE_PACKET_H
