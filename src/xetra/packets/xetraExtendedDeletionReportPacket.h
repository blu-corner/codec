...
class xetraExtendedDeletionReportPacket
{
    public:
        // no value constants
        ...
        {
            mMessageHeaderOut.mTemplateID = 10128;
        ...
        codecState serialize (void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = xetra::serialize (mPartyIDExecutingUnit, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        codecState deserialize (const void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = xetra::deserialize (mPartyIDExecutingUnit, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
...
const uint64_t xetraExtendedDeletionReportPacket::ORDER_ID_MIN = 0UL;
const uint64_t xetraExtendedDeletionReportPacket::ORDER_ID_MAX = 18446744073709551614UL;
const uint64_t xetraExtendedDeletionReportPacket::ORDER_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t xetraExtendedDeletionReportPacket::CL_ORD_ID_MIN = 0UL;
const uint64_t xetraExtendedDeletionReportPacket::CL_ORD_ID_MAX = 18446744073709551614UL;
const uint64_t xetraExtendedDeletionReportPacket::CL_ORD_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t xetraExtendedDeletionReportPacket::ORIG_CL_ORD_ID_MIN = 0UL;
const uint64_t xetraExtendedDeletionReportPacket::ORIG_CL_ORD_ID_MAX = 18446744073709551614UL;
const uint64_t xetraExtendedDeletionReportPacket::ORIG_CL_ORD_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const int64_t xetraExtendedDeletionReportPacket::SECURITY_ID_MIN = -9223372036854775807L;
const int64_t xetraExtendedDeletionReportPacket::SECURITY_ID_MAX = 9223372036854775807L;
const int64_t xetraExtendedDeletionReportPacket::SECURITY_ID_NO_VALUE = 0x8000000000000000;
const uint64_t xetraExtendedDeletionReportPacket::EXEC_ID_MIN = 0UL;
const uint64_t xetraExtendedDeletionReportPacket::EXEC_ID_MAX = 18446744073709551614UL;
const uint64_t xetraExtendedDeletionReportPacket::EXEC_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t xetraExtendedDeletionReportPacket::TRD_REG_TSENTRY_TIME_MIN = 0UL;
const uint64_t xetraExtendedDeletionReportPacket::TRD_REG_TSENTRY_TIME_MAX = 18446744073709551614UL;
const uint64_t xetraExtendedDeletionReportPacket::TRD_REG_TSENTRY_TIME_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
...
const double xetraExtendedDeletionReportPacket::VOLUME_DISCOVERY_PRICE_MIN = -92233720368.54775807;
const double xetraExtendedDeletionReportPacket::VOLUME_DISCOVERY_PRICE_MAX = 92233720368.54775807;
const int64_t xetraExtendedDeletionReportPacket::VOLUME_DISCOVERY_PRICE_NO_VALUE = 0x8000000000000000;
const double xetraExtendedDeletionReportPacket::PEG_OFFSET_VALUE_ABS_MIN = -92233720368.54775807;
const double xetraExtendedDeletionReportPacket::PEG_OFFSET_VALUE_ABS_MAX = 92233720368.54775807;
const int64_t xetraExtendedDeletionReportPacket::PEG_OFFSET_VALUE_ABS_NO_VALUE = 0x8000000000000000;
...
const uint32_t xetraExtendedDeletionReportPacket::MATCH_INST_CROSS_ID_MIN = 0;
const uint32_t xetraExtendedDeletionReportPacket::MATCH_INST_CROSS_ID_MAX = 4294967294;
const uint32_t xetraExtendedDeletionReportPacket::MATCH_INST_CROSS_ID_NO_VALUE = 0xFFFFFFFF;
const uint32_t xetraExtendedDeletionReportPacket::PARTY_IDEXECUTING_UNIT_MIN = 0;
const uint32_t xetraExtendedDeletionReportPacket::PARTY_IDEXECUTING_UNIT_MAX = 4294967294;
const uint32_t xetraExtendedDeletionReportPacket::PARTY_IDEXECUTING_UNIT_NO_VALUE = 0xFFFFFFFF;
const uint32_t xetraExtendedDeletionReportPacket::PARTY_IDSESSION_ID_MIN = 0;
const uint32_t xetraExtendedDeletionReportPacket::PARTY_IDSESSION_ID_MAX = 4294967294;
const uint32_t xetraExtendedDeletionReportPacket::PARTY_IDSESSION_ID_NO_VALUE = 0xFFFFFFFF;
const uint32_t xetraExtendedDeletionReportPacket::PARTY_IDEXECUTING_TRADER_MIN = 0;
const uint32_t xetraExtendedDeletionReportPacket::PARTY_IDEXECUTING_TRADER_MAX = 4294967294;
const uint32_t xetraExtendedDeletionReportPacket::PARTY_IDEXECUTING_TRADER_NO_VALUE = 0xFFFFFFFF;
const uint32_t xetraExtendedDeletionReportPacket::PARTY_IDENTERING_TRADER_MIN = 0;
...
const char xetraExtendedDeletionReportPacket::EXEC_TYPE_NO_VALUE[1] = {0x00};
const size_t xetraExtendedDeletionReportPacket::EXEC_TYPE_MAX_LENGTH = 1;
const int8_t xetraExtendedDeletionReportPacket::SIDE_MIN = 1;
const int8_t xetraExtendedDeletionReportPacket::SIDE_MAX = 2;
const int8_t xetraExtendedDeletionReportPacket::SIDE_NO_VALUE = 0xFF;
const int8_t xetraExtendedDeletionReportPacket::ORD_TYPE_MIN = 1;
const int8_t xetraExtendedDeletionReportPacket::ORD_TYPE_MAX = 4;
const int8_t xetraExtendedDeletionReportPacket::ORD_TYPE_NO_VALUE = 0xFF;
const int8_t xetraExtendedDeletionReportPacket::TRADING_CAPACITY_MIN = 1;
const int8_t xetraExtendedDeletionReportPacket::TRADING_CAPACITY_MAX = 9;
const int8_t xetraExtendedDeletionReportPacket::TRADING_CAPACITY_NO_VALUE = 0xFF;
const int8_t xetraExtendedDeletionReportPacket::TIME_IN_FORCE_MIN = 0;
const int8_t xetraExtendedDeletionReportPacket::TIME_IN_FORCE_MAX = 6;
const int8_t xetraExtendedDeletionReportPacket::TIME_IN_FORCE_NO_VALUE = 0xFF;
const int8_t xetraExtendedDeletionReportPacket::EXEC_INST_MIN = 1;
...
const int8_t xetraExtendedDeletionReportPacket::APPL_SEQ_INDICATOR_NO_VALUE = 0xFF;
const int8_t xetraExtendedDeletionReportPacket::EX_DESTINATION_TYPE_MIN = 3;
const int8_t xetraExtendedDeletionReportPacket::EX_DESTINATION_TYPE_MAX = 3;
const int8_t xetraExtendedDeletionReportPacket::EX_DESTINATION_TYPE_NO_VALUE = 0xFF;
const char xetraExtendedDeletionReportPacket::FREE_TEXT1_NO_VALUE[12] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraExtendedDeletionReportPacket::FREE_TEXT1_MAX_LENGTH = 12;
const char xetraExtendedDeletionReportPacket::FREE_TEXT2_NO_VALUE[12] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
#endif // XETRA_EXTENDEDDELETIONREPORT_PACKET_H
