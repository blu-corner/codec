 ...
 */
#ifndef XETRA_USERLOGOUTRESPONSE_PACKET_H
#define XETRA_USERLOGOUTRESPONSE_PACKET_H
...
class xetraUserLogoutResponsePacket
{
    public:
        // no value constants
...
#endif // XETRA_USERLOGOUTRESPONSE_PACKET_H
