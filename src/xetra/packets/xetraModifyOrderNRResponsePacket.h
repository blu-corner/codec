...
const double xetraModifyOrderNRResponsePacket::LEAVES_QTY_MIN = -922337203685477.5807;
const double xetraModifyOrderNRResponsePacket::LEAVES_QTY_MAX = 922337203685477.5807;
const int64_t xetraModifyOrderNRResponsePacket::LEAVES_QTY_NO_VALUE = 0x8000000000000000;
const double xetraModifyOrderNRResponsePacket::CUM_QTY_MIN = -922337203685477.5807;
const double xetraModifyOrderNRResponsePacket::CUM_QTY_MAX = 922337203685477.5807;
const int64_t xetraModifyOrderNRResponsePacket::CUM_QTY_NO_VALUE = 0x8000000000000000;
const double xetraModifyOrderNRResponsePacket::CXL_QTY_MIN = -922337203685477.5807;
const double xetraModifyOrderNRResponsePacket::CXL_QTY_MAX = 922337203685477.5807;
const int64_t xetraModifyOrderNRResponsePacket::CXL_QTY_NO_VALUE = 0x8000000000000000;
const double xetraModifyOrderNRResponsePacket::DISPLAY_QTY_MIN = -922337203685477.5807;
const double xetraModifyOrderNRResponsePacket::DISPLAY_QTY_MAX = 922337203685477.5807;
const int64_t xetraModifyOrderNRResponsePacket::DISPLAY_QTY_NO_VALUE = 0x8000000000000000;
...
const int16_t xetraModifyOrderNRResponsePacket::EXEC_RESTATEMENT_REASON_MAX = 344;
...
const int8_t xetraModifyOrderNRResponsePacket::TRANSACTION_DELAY_INDICATOR_MIN = 0;
const int8_t xetraModifyOrderNRResponsePacket::TRANSACTION_DELAY_INDICATOR_MAX = 1;
const int8_t xetraModifyOrderNRResponsePacket::TRANSACTION_DELAY_INDICATOR_NO_VALUE = 0xFF;
const char xetraModifyOrderNRResponsePacket::PAD5_NO_VALUE[5] = {0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraModifyOrderNRResponsePacket::PAD5_MAX_LENGTH = 5;
