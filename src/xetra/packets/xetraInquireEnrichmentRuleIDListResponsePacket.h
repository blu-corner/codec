    ...
    public:
        ...
        size_t getRawSize () const
        {
            size_t result = mMessageHeaderOut.getRawSize()
                ...
                + sizeof (mPad6)
                + xetra::getRawSize (mEnrichmentRulesGrp);
            return result;
        }
        ...
        codecState serialize (void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = xetra::serialize (mNoEnrichmentRules, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        codecState deserialize (const void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = xetra::deserialize (mNoEnrichmentRules, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        string toString () const
        {
            ...
            sss << "InquireEnrichmentRuleIDListResponse::"
                ...
                << "[Pad6=" << getPad6 () << "],"
                << "[EnrichmentRulesGrp=" << xetra::toString (getEnrichmentRulesGrp ()) << "]";
            return sss.str();
        }
};
