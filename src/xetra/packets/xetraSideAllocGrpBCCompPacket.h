 ...
 */
#ifndef XETRA_SIDEALLOCGRPBCCOMP_PACKET_H
#define XETRA_SIDEALLOCGRPBCCOMP_PACKET_H
...
class xetraSideAllocGrpBCCompPacket
{
    public:
        // no value constants
...
const double xetraSideAllocGrpBCCompPacket::ALLOC_QTY_MIN = -922337203685477.5807;
const double xetraSideAllocGrpBCCompPacket::ALLOC_QTY_MAX = 922337203685477.5807;
const int64_t xetraSideAllocGrpBCCompPacket::ALLOC_QTY_NO_VALUE = 0x8000000000000000;
const uint32_t xetraSideAllocGrpBCCompPacket::INDIVIDUAL_ALLOC_ID_MIN = 0;
const uint32_t xetraSideAllocGrpBCCompPacket::INDIVIDUAL_ALLOC_ID_MAX = 4294967294;
const uint32_t xetraSideAllocGrpBCCompPacket::INDIVIDUAL_ALLOC_ID_NO_VALUE = 0xFFFFFFFF;
const char xetraSideAllocGrpBCCompPacket::PARTY_EXECUTING_FIRM_NO_VALUE[5] = {0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraSideAllocGrpBCCompPacket::PARTY_EXECUTING_FIRM_MAX_LENGTH = 5;
const char xetraSideAllocGrpBCCompPacket::PARTY_EXECUTING_TRADER_NO_VALUE[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraSideAllocGrpBCCompPacket::PARTY_EXECUTING_TRADER_MAX_LENGTH = 6;
const int8_t xetraSideAllocGrpBCCompPacket::SIDE_MIN = 1;
const int8_t xetraSideAllocGrpBCCompPacket::SIDE_MAX = 2;
const int8_t xetraSideAllocGrpBCCompPacket::SIDE_NO_VALUE = 0xFF;
const int8_t xetraSideAllocGrpBCCompPacket::TRADE_ALLOC_STATUS_MIN = 0;
const int8_t xetraSideAllocGrpBCCompPacket::TRADE_ALLOC_STATUS_MAX = 5;
const int8_t xetraSideAllocGrpBCCompPacket::TRADE_ALLOC_STATUS_NO_VALUE = 0xFF;
const char xetraSideAllocGrpBCCompPacket::PAD7_NO_VALUE[7] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraSideAllocGrpBCCompPacket::PAD7_MAX_LENGTH = 7;


} // namespace neueda

#endif // XETRA_SIDEALLOCGRPBCCOMP_PACKET_H
