 ...
 */
#ifndef XETRA_CROSSREQUESTRESPONSE_PACKET_H
#define XETRA_CROSSREQUESTRESPONSE_PACKET_H
...
class xetraCrossRequestResponsePacket
{
    public:
        // no value constants
        ...
        // constructor
        xetraCrossRequestResponsePacket ()
        {
...
const uint64_t xetraCrossRequestResponsePacket::EXEC_ID_MIN = 0UL;
const uint64_t xetraCrossRequestResponsePacket::EXEC_ID_MAX = 18446744073709551614UL;
const uint64_t xetraCrossRequestResponsePacket::EXEC_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;


} // namespace neueda

#endif // XETRA_CROSSREQUESTRESPONSE_PACKET_H
