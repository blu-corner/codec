 ...
 */
#ifndef SWX_REJECTEDORDERMESSAGE_PACKET_H
#define SWX_REJECTEDORDERMESSAGE_PACKET_H
...
PACKED(class swxRejectedOrderMessage
{
    public:
        swxHeader mHeader;
        ...
        swxRejectedOrderMessage ()
        {
            mHeader.mMessageLength = htons(sizeof (swxRejectedOrderMessage) - 2);
