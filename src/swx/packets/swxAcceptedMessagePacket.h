 ...
 */
#ifndef SWX_ACCEPTEDMESSAGE_PACKET_H
#define SWX_ACCEPTEDMESSAGE_PACKET_H
...
PACKED(class swxAcceptedMessage
{
    public:
        swxHeader mHeader;
        ...
        swxAcceptedMessage ()
        {
            mHeader.mMessageLength = htons(sizeof (swxAcceptedMessage) - 2);
