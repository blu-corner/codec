 ...
 */
#ifndef _OPTIQ_NEWORDERCLEARINGFIELDS_PACKET_H_
#define _OPTIQ_NEWORDERCLEARINGFIELDS_PACKET_H_
...
PACKED(class optiqNewOrderClearingFieldsPacket
{
public:
    ...
    optiqNewOrderClearingFieldsPacket ()
    {
