...
PACKED(class optiqCancelRequestPacket
{
public:
    ...
    {
        mFrameLength = sizeof (optiqCancelRequestPacket) - sizeof (uint16_t);
        mHeader.setBlockLength (sizeof (optiqCancelRequestPacket) -
