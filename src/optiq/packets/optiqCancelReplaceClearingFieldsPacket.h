 ...
 */
#ifndef _OPTIQ_CANCELREPLACECLEARINGFIELDS_PACKET_H_
#define _OPTIQ_CANCELREPLACECLEARINGFIELDS_PACKET_H_
...
PACKED(class optiqCancelReplaceClearingFieldsPacket
{
public:
    ...
    optiqCancelReplaceClearingFieldsPacket ()
    {
