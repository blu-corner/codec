 ...
 */
#ifndef _OPTIQ_CANCELREPLACE_PACKET_H_
#define _OPTIQ_CANCELREPLACE_PACKET_H_
...
PACKED(class optiqCancelReplacePacket
{
public:
    ...
    optiqCancelReplacePacket ()
    {
        mFrameLength = sizeof (optiqCancelReplacePacket) - sizeof (uint16_t);
        mHeader.setBlockLength (sizeof (optiqCancelReplacePacket) -
                                sizeof (optiqMessageHeaderPacket) -
                                sizeof (mFrameLength));
        mHeader.setTemplateId (OptiqCancelReplaceTemplateId);
