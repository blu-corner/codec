 ...
 */
#ifndef BORSAITALIANA_BUSINESSREJECT_PACKET_H
#define BORSAITALIANA_BUSINESSREJECT_PACKET_H
...
PACKED(class BorsaItalianaBusinessReject
{
    public:
        ...
        char mReservedField1[2];

        BorsaItalianaBusinessReject ()
        {
            mHeader.mMessageLength = (int16_t)sizeof (BorsaItalianaBusinessReject) - ((int16_t)sizeof (BorsaItalianaHeader) - 1);
        ...
        {
            return setString (mReservedField1, v, 2);
        }

        string getReservedField1 ()
        {
            return getString (mReservedField1, 2);
        }
