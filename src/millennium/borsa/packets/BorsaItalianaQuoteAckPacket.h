 ...
 */
#ifndef BORSAITALIANA_QUOTEACK_PACKET_H
#define BORSAITALIANA_QUOTEACK_PACKET_H
...
PACKED(class BorsaItalianaQuoteAck
{
    public:
        ...
        BorsaItalianaQuoteAck ()
        {
            mHeader.mMessageLength = (int16_t)sizeof (BorsaItalianaQuoteAck) - ((int16_t)sizeof (BorsaItalianaHeader) - 1);
