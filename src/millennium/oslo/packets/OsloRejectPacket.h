 ...
 */
#ifndef OSLO_REJECT_PACKET_H
#define OSLO_REJECT_PACKET_H
...
PACKED(class OsloReject
{
    public:
        ...
        OsloReject ()
        {
            mHeader.mMessageLength = (int16_t)sizeof (OsloReject) - ((int16_t)sizeof (OsloHeader) - 1);
