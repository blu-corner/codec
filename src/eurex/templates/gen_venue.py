...
input = ET.parse(args.eti)
root = input.getroot()
output = ET.Element('exchange', {'name':'Eurex'})

#generate GLOBAL section
g = ET.SubElement(output, 'global', {'name':'global'})
ET.SubElement(g, 'parameter', {'name':'MessageSpecTitle', 'value':'Enhanced Trading Interface - Derivatives Message Reference - Release 7.1 - 11 Apr 2019'})
ET.SubElement(g, 'parameter', {'name':'MessageSpecFilename', 'value':'T7-Enhanced-Trading-Interface-Derivatives-Message-Reference.pdf'})
ET.SubElement(g, 'parameter', {'name':'ProtocolGroup', 'value':'EUREX'})
...
ET.SubElement(g, 'parameter', {'name':'VenueMIC', 'value':'XEUR'})
ET.SubElement(g, 'parameter', {'name':'Interface', 'value':'OrderEntry'})
ET.SubElement(g, 'parameter', {'name':'ProtocolVersion', 'value':'7.1'})
ET.SubElement(g, 'parameter', {'name':'ProtocolIssueDate', 'value':'2019.04.11'})
