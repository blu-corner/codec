 ...
 */
#ifndef EUREX_BROADCASTERRORNOTIFICATION_PACKET_H
#define EUREX_BROADCASTERRORNOTIFICATION_PACKET_H
...
class eurexBroadcastErrorNotificationPacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexBroadcastErrorNotificationPacket ()
        {
        ...
        codecState serialize (void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mApplIDStatus, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mRefApplSubID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        codecState deserialize (const void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mApplIDStatus, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mRefApplSubID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
...
const uint32_t eurexBroadcastErrorNotificationPacket::APPL_IDSTATUS_MIN = 0;
const uint32_t eurexBroadcastErrorNotificationPacket::APPL_IDSTATUS_MAX = 4294967294;
const uint32_t eurexBroadcastErrorNotificationPacket::APPL_IDSTATUS_NO_VALUE = 0xFFFFFFFF;
const uint32_t eurexBroadcastErrorNotificationPacket::REF_APPL_SUB_ID_MIN = 0;
const uint32_t eurexBroadcastErrorNotificationPacket::REF_APPL_SUB_ID_MAX = 4294967294;
const uint32_t eurexBroadcastErrorNotificationPacket::REF_APPL_SUB_ID_NO_VALUE = 0xFFFFFFFF;
const int16_t eurexBroadcastErrorNotificationPacket::VAR_TEXT_LEN_MIN = 0;
const int16_t eurexBroadcastErrorNotificationPacket::VAR_TEXT_LEN_MAX = 2000;
const int16_t eurexBroadcastErrorNotificationPacket::VAR_TEXT_LEN_NO_VALUE = 0xFFFF;
const int8_t eurexBroadcastErrorNotificationPacket::REF_APPL_ID_MIN = 0;
const int8_t eurexBroadcastErrorNotificationPacket::REF_APPL_ID_MAX = 10;
const int8_t eurexBroadcastErrorNotificationPacket::REF_APPL_ID_NO_VALUE = 0xFF;
const int8_t eurexBroadcastErrorNotificationPacket::SESSION_STATUS_MIN = 0;
const int8_t eurexBroadcastErrorNotificationPacket::SESSION_STATUS_MAX = 4;
const int8_t eurexBroadcastErrorNotificationPacket::SESSION_STATUS_NO_VALUE = 0xFF;
const char eurexBroadcastErrorNotificationPacket::PAD4_NO_VALUE[4] = {0x00, 0x00, 0x00, 0x00};
const size_t eurexBroadcastErrorNotificationPacket::PAD4_MAX_LENGTH = 4;
const size_t eurexBroadcastErrorNotificationPacket::VAR_TEXT_MAX_LENGTH = 2000;


} // namespace neueda

#endif // EUREX_BROADCASTERRORNOTIFICATION_PACKET_H
