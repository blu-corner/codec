 ...
 */
#ifndef EUREX_MODIFYBASKETTRADEREQUEST_PACKET_H
#define EUREX_MODIFYBASKETTRADEREQUEST_PACKET_H
...
class eurexModifyBasketTradeRequestPacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexModifyBasketTradeRequestPacket ()
        {
            mMessageHeaderIn.mTemplateID = 10621;
...
const uint64_t eurexModifyBasketTradeRequestPacket::BASKET_TRD_MATCH_ID_MIN = 0UL;
const uint64_t eurexModifyBasketTradeRequestPacket::BASKET_TRD_MATCH_ID_MAX = 18446744073709551614UL;
const uint64_t eurexModifyBasketTradeRequestPacket::BASKET_TRD_MATCH_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint32_t eurexModifyBasketTradeRequestPacket::BASKET_EXEC_ID_MIN = 0;
const uint32_t eurexModifyBasketTradeRequestPacket::BASKET_EXEC_ID_MAX = 4294967294;
const uint32_t eurexModifyBasketTradeRequestPacket::BASKET_EXEC_ID_NO_VALUE = 0xFFFFFFFF;
const int32_t eurexModifyBasketTradeRequestPacket::MARKET_SEGMENT_ID_MIN = -2147483647;
const int32_t eurexModifyBasketTradeRequestPacket::MARKET_SEGMENT_ID_MAX = 2147483647;
const int32_t eurexModifyBasketTradeRequestPacket::MARKET_SEGMENT_ID_NO_VALUE = 0x80000000;
const int32_t eurexModifyBasketTradeRequestPacket::MATURITY_MONTH_YEAR_MIN = 0;
const int32_t eurexModifyBasketTradeRequestPacket::MATURITY_MONTH_YEAR_MAX = 999912;
const int32_t eurexModifyBasketTradeRequestPacket::MATURITY_MONTH_YEAR_NO_VALUE = 0xFFFFFFFF;
const int16_t eurexModifyBasketTradeRequestPacket::TRD_TYPE_MIN = 1;
const int16_t eurexModifyBasketTradeRequestPacket::TRD_TYPE_MAX = 1010;
const int16_t eurexModifyBasketTradeRequestPacket::TRD_TYPE_NO_VALUE = 0xFFFF;
const int8_t eurexModifyBasketTradeRequestPacket::TRADE_REPORT_TYPE_MIN = 0;
const int8_t eurexModifyBasketTradeRequestPacket::TRADE_REPORT_TYPE_MAX = 13;
const int8_t eurexModifyBasketTradeRequestPacket::TRADE_REPORT_TYPE_NO_VALUE = 0xFF;
const int8_t eurexModifyBasketTradeRequestPacket::NO_BASKET_ROOT_PARTY_GRPS_MIN = 2;
const int8_t eurexModifyBasketTradeRequestPacket::NO_BASKET_ROOT_PARTY_GRPS_MAX = 2;
const int8_t eurexModifyBasketTradeRequestPacket::NO_BASKET_ROOT_PARTY_GRPS_NO_VALUE = 0xFF;
const int8_t eurexModifyBasketTradeRequestPacket::NO_INSTRMT_MATCH_SIDES_MIN = 1;
const int8_t eurexModifyBasketTradeRequestPacket::NO_INSTRMT_MATCH_SIDES_MAX = 99;
const int8_t eurexModifyBasketTradeRequestPacket::NO_INSTRMT_MATCH_SIDES_NO_VALUE = 0xFF;
const uint8_t eurexModifyBasketTradeRequestPacket::NO_BASKET_SIDE_ALLOC_MIN = 1;
const uint8_t eurexModifyBasketTradeRequestPacket::NO_BASKET_SIDE_ALLOC_MAX = 198;
const uint8_t eurexModifyBasketTradeRequestPacket::NO_BASKET_SIDE_ALLOC_NO_VALUE = 0xFF;
const char eurexModifyBasketTradeRequestPacket::BASKET_TRADE_REPORT_TEXT_NO_VALUE[20] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexModifyBasketTradeRequestPacket::BASKET_TRADE_REPORT_TEXT_MAX_LENGTH = 20;
const char eurexModifyBasketTradeRequestPacket::TRADE_REPORT_ID_NO_VALUE[20] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexModifyBasketTradeRequestPacket::TRADE_REPORT_ID_MAX_LENGTH = 20;
const char eurexModifyBasketTradeRequestPacket::PAD6_NO_VALUE[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexModifyBasketTradeRequestPacket::PAD6_MAX_LENGTH = 6;
const size_t eurexModifyBasketTradeRequestPacket::BASKET_ROOT_PARTY_GRP_MIN = 2;
const size_t eurexModifyBasketTradeRequestPacket::BASKET_ROOT_PARTY_GRP_MAX = 2;
const size_t eurexModifyBasketTradeRequestPacket::INSTRMT_MATCH_SIDE_GRP_MIN = 1;
const size_t eurexModifyBasketTradeRequestPacket::INSTRMT_MATCH_SIDE_GRP_MAX = 99;
const size_t eurexModifyBasketTradeRequestPacket::BASKET_SIDE_ALLOC_GRP_MIN = 1;
const size_t eurexModifyBasketTradeRequestPacket::BASKET_SIDE_ALLOC_GRP_MAX = 198;


} // namespace neueda

#endif // EUREX_MODIFYBASKETTRADEREQUEST_PACKET_H
