 ...
 */
#ifndef EUREX_MMPARAMETERDEFINITIONRESPONSE_PACKET_H
#define EUREX_MMPARAMETERDEFINITIONRESPONSE_PACKET_H
...
class eurexMMParameterDefinitionResponsePacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexMMParameterDefinitionResponsePacket ()
        {
            mMessageHeaderOut.mTemplateID = 10304;
        ...
        {
            stringstream sss;
            sss << "MMParameterDefinitionResponse::"
...
const uint64_t eurexMMParameterDefinitionResponsePacket::EXEC_ID_MIN = 0UL;
const uint64_t eurexMMParameterDefinitionResponsePacket::EXEC_ID_MAX = 18446744073709551614UL;
const uint64_t eurexMMParameterDefinitionResponsePacket::EXEC_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;


} // namespace neueda

#endif // EUREX_MMPARAMETERDEFINITIONRESPONSE_PACKET_H
