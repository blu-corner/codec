    ...
    public:
        ...
        size_t getRawSize () const
        {
            size_t result = mMessageHeaderOut.getRawSize()
                ...
                + sizeof (mPad1)
                + eurex::getRawSize (mQuoteEventGrp)
                + eurex::getRawSize (mQuoteLegExecGrp);
            return result;
        }
        ...
        codecState serialize (void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mNoQuoteEvents, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        codecState deserialize (const void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mNoQuoteEvents, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        string toString () const
        {
            ...
            sss << "QuoteExecutionReport::"
                ...
                << "[Pad1=" << getPad1 () << "],"
                << "[QuoteEventGrp=" << eurex::toString (getQuoteEventGrp ()) << "],"
                << "[QuoteLegExecGrp=" << eurex::toString (getQuoteLegExecGrp ()) << "]";
            return sss.str();
        }
};
