 ...
 */
#ifndef EUREX_NRBCHEADERCOMP_PACKET_H
#define EUREX_NRBCHEADERCOMP_PACKET_H
...
class eurexNRBCHeaderCompPacket
{
    public:
        // no value constants
...
const uint64_t eurexNRBCHeaderCompPacket::SENDING_TIME_MIN = 0UL;
const uint64_t eurexNRBCHeaderCompPacket::SENDING_TIME_MAX = 18446744073709551614UL;
const uint64_t eurexNRBCHeaderCompPacket::SENDING_TIME_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint32_t eurexNRBCHeaderCompPacket::APPL_SUB_ID_MIN = 0;
const uint32_t eurexNRBCHeaderCompPacket::APPL_SUB_ID_MAX = 4294967294;
const uint32_t eurexNRBCHeaderCompPacket::APPL_SUB_ID_NO_VALUE = 0xFFFFFFFF;
const int8_t eurexNRBCHeaderCompPacket::APPL_ID_MIN = 0;
const int8_t eurexNRBCHeaderCompPacket::APPL_ID_MAX = 10;
const int8_t eurexNRBCHeaderCompPacket::APPL_ID_NO_VALUE = 0xFF;
const int8_t eurexNRBCHeaderCompPacket::LAST_FRAGMENT_MIN = 0;
const int8_t eurexNRBCHeaderCompPacket::LAST_FRAGMENT_MAX = 1;
const int8_t eurexNRBCHeaderCompPacket::LAST_FRAGMENT_NO_VALUE = 0xFF;
const char eurexNRBCHeaderCompPacket::PAD2_NO_VALUE[2] = {0x00, 0x00};
const size_t eurexNRBCHeaderCompPacket::PAD2_MAX_LENGTH = 2;


} // namespace neueda

#endif // EUREX_NRBCHEADERCOMP_PACKET_H
