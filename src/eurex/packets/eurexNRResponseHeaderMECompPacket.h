 ...
 */
#ifndef EUREX_NRRESPONSEHEADERMECOMP_PACKET_H
#define EUREX_NRRESPONSEHEADERMECOMP_PACKET_H
...
class eurexNRResponseHeaderMECompPacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexNRResponseHeaderMECompPacket ()
        {
...
const uint64_t eurexNRResponseHeaderMECompPacket::REQUEST_TIME_MIN = 0UL;
const uint64_t eurexNRResponseHeaderMECompPacket::REQUEST_TIME_MAX = 18446744073709551614UL;
const uint64_t eurexNRResponseHeaderMECompPacket::REQUEST_TIME_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexNRResponseHeaderMECompPacket::TRD_REG_TSTIME_IN_MIN = 0UL;
const uint64_t eurexNRResponseHeaderMECompPacket::TRD_REG_TSTIME_IN_MAX = 18446744073709551614UL;
const uint64_t eurexNRResponseHeaderMECompPacket::TRD_REG_TSTIME_IN_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexNRResponseHeaderMECompPacket::TRD_REG_TSTIME_OUT_MIN = 0UL;
const uint64_t eurexNRResponseHeaderMECompPacket::TRD_REG_TSTIME_OUT_MAX = 18446744073709551614UL;
const uint64_t eurexNRResponseHeaderMECompPacket::TRD_REG_TSTIME_OUT_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexNRResponseHeaderMECompPacket::RESPONSE_IN_MIN = 0UL;
const uint64_t eurexNRResponseHeaderMECompPacket::RESPONSE_IN_MAX = 18446744073709551614UL;
const uint64_t eurexNRResponseHeaderMECompPacket::RESPONSE_IN_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexNRResponseHeaderMECompPacket::SENDING_TIME_MIN = 0UL;
const uint64_t eurexNRResponseHeaderMECompPacket::SENDING_TIME_MAX = 18446744073709551614UL;
const uint64_t eurexNRResponseHeaderMECompPacket::SENDING_TIME_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint32_t eurexNRResponseHeaderMECompPacket::MSG_SEQ_NUM_MIN = 0;
const uint32_t eurexNRResponseHeaderMECompPacket::MSG_SEQ_NUM_MAX = 4294967294;
const uint32_t eurexNRResponseHeaderMECompPacket::MSG_SEQ_NUM_NO_VALUE = 0xFFFFFFFF;
const int8_t eurexNRResponseHeaderMECompPacket::LAST_FRAGMENT_MIN = 0;
const int8_t eurexNRResponseHeaderMECompPacket::LAST_FRAGMENT_MAX = 1;
const int8_t eurexNRResponseHeaderMECompPacket::LAST_FRAGMENT_NO_VALUE = 0xFF;
const char eurexNRResponseHeaderMECompPacket::PAD3_NO_VALUE[3] = {0x00, 0x00, 0x00};
const size_t eurexNRResponseHeaderMECompPacket::PAD3_MAX_LENGTH = 3;


} // namespace neueda

#endif // EUREX_NRRESPONSEHEADERMECOMP_PACKET_H
