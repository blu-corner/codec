 ...
 */
#ifndef EUREX_USERLOGINRESPONSE_PACKET_H
#define EUREX_USERLOGINRESPONSE_PACKET_H
...
class eurexUserLoginResponsePacket
{
    public:
        // no value constants
...
#endif // EUREX_USERLOGINRESPONSE_PACKET_H
