 ...
 */
#ifndef EUREX_RBCHEADERCOMP_PACKET_H
#define EUREX_RBCHEADERCOMP_PACKET_H
...
class eurexRBCHeaderCompPacket
{
    public:
        // no value constants
        ...
        codecState serialize (void *buf, size_t len, size_t &used)
        {
            ...
            state = eurex::serialize (mApplSeqNum, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        codecState deserialize (const void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mApplSeqNum, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
...
const uint64_t eurexRBCHeaderCompPacket::SENDING_TIME_MIN = 0UL;
const uint64_t eurexRBCHeaderCompPacket::SENDING_TIME_MAX = 18446744073709551614UL;
const uint64_t eurexRBCHeaderCompPacket::SENDING_TIME_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexRBCHeaderCompPacket::APPL_SEQ_NUM_MIN = 0UL;
const uint64_t eurexRBCHeaderCompPacket::APPL_SEQ_NUM_MAX = 18446744073709551614UL;
const uint64_t eurexRBCHeaderCompPacket::APPL_SEQ_NUM_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint32_t eurexRBCHeaderCompPacket::APPL_SUB_ID_MIN = 0;
const uint32_t eurexRBCHeaderCompPacket::APPL_SUB_ID_MAX = 4294967294;
const uint32_t eurexRBCHeaderCompPacket::APPL_SUB_ID_NO_VALUE = 0xFFFFFFFF;
const uint16_t eurexRBCHeaderCompPacket::PARTITION_ID_MIN = 0;
const uint16_t eurexRBCHeaderCompPacket::PARTITION_ID_MAX = 65534;
const uint16_t eurexRBCHeaderCompPacket::PARTITION_ID_NO_VALUE = 0xFFFF;
const int8_t eurexRBCHeaderCompPacket::APPL_RESEND_FLAG_MIN = 0;
const int8_t eurexRBCHeaderCompPacket::APPL_RESEND_FLAG_MAX = 1;
const int8_t eurexRBCHeaderCompPacket::APPL_RESEND_FLAG_NO_VALUE = 0xFF;
const int8_t eurexRBCHeaderCompPacket::APPL_ID_MIN = 0;
const int8_t eurexRBCHeaderCompPacket::APPL_ID_MAX = 10;
const int8_t eurexRBCHeaderCompPacket::APPL_ID_NO_VALUE = 0xFF;
const int8_t eurexRBCHeaderCompPacket::LAST_FRAGMENT_MIN = 0;
const int8_t eurexRBCHeaderCompPacket::LAST_FRAGMENT_MAX = 1;
const int8_t eurexRBCHeaderCompPacket::LAST_FRAGMENT_NO_VALUE = 0xFF;
const char eurexRBCHeaderCompPacket::PAD7_NO_VALUE[7] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexRBCHeaderCompPacket::PAD7_MAX_LENGTH = 7;


} // namespace neueda

#endif // EUREX_RBCHEADERCOMP_PACKET_H
