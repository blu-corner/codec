 ...
 */
#ifndef EUREX_SRQSNEGOTIATIONSTATUSNOTIFICATION_PACKET_H
#define EUREX_SRQSNEGOTIATIONSTATUSNOTIFICATION_PACKET_H
...
class eurexSRQSNegotiationStatusNotificationPacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexSRQSNegotiationStatusNotificationPacket ()
        {
            mMessageHeaderOut.mTemplateID = 10715;
        ...
        {
            stringstream sss;
            sss << "SRQSNegotiationStatusNotification::"
...
const uint64_t eurexSRQSNegotiationStatusNotificationPacket::TRANSACT_TIME_MIN = 0UL;
const uint64_t eurexSRQSNegotiationStatusNotificationPacket::TRANSACT_TIME_MAX = 18446744073709551614UL;
const uint64_t eurexSRQSNegotiationStatusNotificationPacket::TRANSACT_TIME_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint32_t eurexSRQSNegotiationStatusNotificationPacket::NEGOTIATION_ID_MIN = 0;
const uint32_t eurexSRQSNegotiationStatusNotificationPacket::NEGOTIATION_ID_MAX = 4294967294;
const uint32_t eurexSRQSNegotiationStatusNotificationPacket::NEGOTIATION_ID_NO_VALUE = 0xFFFFFFFF;
const int8_t eurexSRQSNegotiationStatusNotificationPacket::QUOTE_STATUS_MIN = 6;
const int8_t eurexSRQSNegotiationStatusNotificationPacket::QUOTE_STATUS_MAX = 17;
const int8_t eurexSRQSNegotiationStatusNotificationPacket::QUOTE_STATUS_NO_VALUE = 0xFF;
const char eurexSRQSNegotiationStatusNotificationPacket::FIRM_NEGOTIATION_ID_NO_VALUE[20] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexSRQSNegotiationStatusNotificationPacket::FIRM_NEGOTIATION_ID_MAX_LENGTH = 20;
const char eurexSRQSNegotiationStatusNotificationPacket::PAD7_NO_VALUE[7] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexSRQSNegotiationStatusNotificationPacket::PAD7_MAX_LENGTH = 7;


} // namespace neueda

#endif // EUREX_SRQSNEGOTIATIONSTATUSNOTIFICATION_PACKET_H
