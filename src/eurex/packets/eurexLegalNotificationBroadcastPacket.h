 ...
 */
#ifndef EUREX_LEGALNOTIFICATIONBROADCAST_PACKET_H
#define EUREX_LEGALNOTIFICATIONBROADCAST_PACKET_H
...
class eurexLegalNotificationBroadcastPacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexLegalNotificationBroadcastPacket ()
        {
...
const uint64_t eurexLegalNotificationBroadcastPacket::TRANSACT_TIME_MIN = 0UL;
const uint64_t eurexLegalNotificationBroadcastPacket::TRANSACT_TIME_MAX = 18446744073709551614UL;
const uint64_t eurexLegalNotificationBroadcastPacket::TRANSACT_TIME_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const int16_t eurexLegalNotificationBroadcastPacket::VAR_TEXT_LEN_MIN = 0;
const int16_t eurexLegalNotificationBroadcastPacket::VAR_TEXT_LEN_MAX = 2000;
const int16_t eurexLegalNotificationBroadcastPacket::VAR_TEXT_LEN_NO_VALUE = 0xFFFF;
const int8_t eurexLegalNotificationBroadcastPacket::USER_STATUS_MIN = 7;
const int8_t eurexLegalNotificationBroadcastPacket::USER_STATUS_MAX = 11;
const int8_t eurexLegalNotificationBroadcastPacket::USER_STATUS_NO_VALUE = 0xFF;
const char eurexLegalNotificationBroadcastPacket::PAD5_NO_VALUE[5] = {0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexLegalNotificationBroadcastPacket::PAD5_MAX_LENGTH = 5;
const size_t eurexLegalNotificationBroadcastPacket::VAR_TEXT_MAX_LENGTH = 2000;


} // namespace neueda

#endif // EUREX_LEGALNOTIFICATIONBROADCAST_PACKET_H
