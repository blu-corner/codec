 ...
 */
#ifndef EUREX_ENTERTESTRADEREQUEST_PACKET_H
#define EUREX_ENTERTESTRADEREQUEST_PACKET_H
...
class eurexEnterTESTradeRequestPacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexEnterTESTradeRequestPacket ()
        {
        ...
        size_t getRawSize () const
        {
            size_t result = mMessageHeaderIn.getRawSize()
                ...
                + sizeof (mPad7)
                + eurex::getRawSize (mSideAllocGrp)
                + eurex::getRawSize (mTrdInstrmntLegGrp)
                + eurex::getRawSize (mInstrumentEventGrp)
                + eurex::getRawSize (mInstrumentAttributeGrp)
                + mUnderlyingStipGrp.getRawSize()
                + eurex::getRawSize (mSRQSRelatedTradeIDGrp);
            return result;
        }
        ...
        codecState serialize (void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mRelatedTradeQuantity, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mUnderlyingQty, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mMarketSegmentID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mUnderlyingSettlementDate, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mUnderlyingMaturityDate, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mRelatedTradeID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mRelatedMarketSegmentID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mNegotiationID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mNoSRQSRelatedTradeIDs, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mNoSideAllocs, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mNoEvents, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mNoLegs, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mNoInstrAttrib, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mNoUnderlyingStips, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mPartyIDSettlementLocation, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mHedgeType, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mTradeReportText, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mTradeReportID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mUnderlyingSecurityID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mUnderlyingSecurityDesc, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mUnderlyingCurrency, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mUnderlyingIssuer, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        codecState deserialize (const void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mRelatedTradeQuantity, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mUnderlyingQty, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mMarketSegmentID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mUnderlyingSettlementDate, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mUnderlyingMaturityDate, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mRelatedTradeID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mRelatedMarketSegmentID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mNegotiationID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mNoSRQSRelatedTradeIDs, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mNoSideAllocs, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mNoEvents, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mNoLegs, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mNoInstrAttrib, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mNoUnderlyingStips, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mPartyIDSettlementLocation, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mHedgeType, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mTradeReportText, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mTradeReportID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mUnderlyingSecurityID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mUnderlyingSecurityDesc, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mUnderlyingCurrency, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mUnderlyingIssuer, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        string toString () const
        {
            ...
            sss << "EnterTESTradeRequest::"
                ...
                << "[Pad7=" << getPad7 () << "],"
                << "[SideAllocGrp=" << eurex::toString (getSideAllocGrp ()) << "],"
                << "[TrdInstrmntLegGrp=" << eurex::toString (getTrdInstrmntLegGrp ()) << "],"
                << "[InstrumentEventGrp=" << eurex::toString (getInstrumentEventGrp ()) << "],"
                << "[InstrumentAttributeGrp=" << eurex::toString (getInstrumentAttributeGrp ()) << "],"
                << "[UnderlyingStipGrp=" << mUnderlyingStipGrp.toString () << "],"
                << "[SRQSRelatedTradeIDGrp=" << eurex::toString (getSRQSRelatedTradeIDGrp ()) << "]";
            return sss.str();
        }
};

const int64_t eurexEnterTESTradeRequestPacket::SECURITY_ID_MIN = -9223372036854775807L;
const int64_t eurexEnterTESTradeRequestPacket::SECURITY_ID_MAX = 9223372036854775807L;
const int64_t eurexEnterTESTradeRequestPacket::SECURITY_ID_NO_VALUE = 0x8000000000000000;
const double eurexEnterTESTradeRequestPacket::LAST_PX_MIN = -92233720368.54775807;
const double eurexEnterTESTradeRequestPacket::LAST_PX_MAX = 92233720368.54775807;
const int64_t eurexEnterTESTradeRequestPacket::LAST_PX_NO_VALUE = 0x8000000000000000;
const uint64_t eurexEnterTESTradeRequestPacket::TRANS_BKD_TIME_MIN = 0UL;
const uint64_t eurexEnterTESTradeRequestPacket::TRANS_BKD_TIME_MAX = 18446744073709551614UL;
const uint64_t eurexEnterTESTradeRequestPacket::TRANS_BKD_TIME_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const double eurexEnterTESTradeRequestPacket::UNDERLYING_PX_MIN = -92233720368.54775807;
const double eurexEnterTESTradeRequestPacket::UNDERLYING_PX_MAX = 92233720368.54775807;
const int64_t eurexEnterTESTradeRequestPacket::UNDERLYING_PX_NO_VALUE = 0x8000000000000000;
const double eurexEnterTESTradeRequestPacket::RELATED_CLOSE_PRICE_MIN = -9223372036854.775807;
const double eurexEnterTESTradeRequestPacket::RELATED_CLOSE_PRICE_MAX = 9223372036854.775807;
const int64_t eurexEnterTESTradeRequestPacket::RELATED_CLOSE_PRICE_NO_VALUE = 0x8000000000000000;
const double eurexEnterTESTradeRequestPacket::RELATED_TRADE_QUANTITY_MIN = -922337203685477.5807;
const double eurexEnterTESTradeRequestPacket::RELATED_TRADE_QUANTITY_MAX = 922337203685477.5807;
const int64_t eurexEnterTESTradeRequestPacket::RELATED_TRADE_QUANTITY_NO_VALUE = 0x8000000000000000;
const double eurexEnterTESTradeRequestPacket::UNDERLYING_QTY_MIN = -922337203685477.5807;
const double eurexEnterTESTradeRequestPacket::UNDERLYING_QTY_MAX = 922337203685477.5807;
const int64_t eurexEnterTESTradeRequestPacket::UNDERLYING_QTY_NO_VALUE = 0x8000000000000000;
const int32_t eurexEnterTESTradeRequestPacket::MARKET_SEGMENT_ID_MIN = -2147483647;
const int32_t eurexEnterTESTradeRequestPacket::MARKET_SEGMENT_ID_MAX = 2147483647;
const int32_t eurexEnterTESTradeRequestPacket::MARKET_SEGMENT_ID_NO_VALUE = 0x80000000;
const int32_t eurexEnterTESTradeRequestPacket::UNDERLYING_SETTLEMENT_DATE_MIN = 0;
const int32_t eurexEnterTESTradeRequestPacket::UNDERLYING_SETTLEMENT_DATE_MAX = 99991231;
const int32_t eurexEnterTESTradeRequestPacket::UNDERLYING_SETTLEMENT_DATE_NO_VALUE = 0xFFFFFFFF;
const int32_t eurexEnterTESTradeRequestPacket::UNDERLYING_MATURITY_DATE_MIN = 0;
const int32_t eurexEnterTESTradeRequestPacket::UNDERLYING_MATURITY_DATE_MAX = 99991231;
const int32_t eurexEnterTESTradeRequestPacket::UNDERLYING_MATURITY_DATE_NO_VALUE = 0xFFFFFFFF;
const uint32_t eurexEnterTESTradeRequestPacket::RELATED_TRADE_ID_MIN = 0;
const uint32_t eurexEnterTESTradeRequestPacket::RELATED_TRADE_ID_MAX = 4294967294;
const uint32_t eurexEnterTESTradeRequestPacket::RELATED_TRADE_ID_NO_VALUE = 0xFFFFFFFF;
const int32_t eurexEnterTESTradeRequestPacket::RELATED_MARKET_SEGMENT_ID_MIN = -2147483647;
const int32_t eurexEnterTESTradeRequestPacket::RELATED_MARKET_SEGMENT_ID_MAX = 2147483647;
const int32_t eurexEnterTESTradeRequestPacket::RELATED_MARKET_SEGMENT_ID_NO_VALUE = 0x80000000;
const uint32_t eurexEnterTESTradeRequestPacket::NEGOTIATION_ID_MIN = 0;
const uint32_t eurexEnterTESTradeRequestPacket::NEGOTIATION_ID_MAX = 4294967294;
const uint32_t eurexEnterTESTradeRequestPacket::NEGOTIATION_ID_NO_VALUE = 0xFFFFFFFF;
const int8_t eurexEnterTESTradeRequestPacket::NO_SRQSRELATED_TRADE_IDS_MIN = 0;
const int8_t eurexEnterTESTradeRequestPacket::NO_SRQSRELATED_TRADE_IDS_MAX = 12;
const int8_t eurexEnterTESTradeRequestPacket::NO_SRQSRELATED_TRADE_IDS_NO_VALUE = 0xFF;
const char eurexEnterTESTradeRequestPacket::PAD1_NO_VALUE[1] = {0x00};
const size_t eurexEnterTESTradeRequestPacket::PAD1_MAX_LENGTH = 1;
const int16_t eurexEnterTESTradeRequestPacket::TRD_TYPE_MIN = 1;
const int16_t eurexEnterTESTradeRequestPacket::TRD_TYPE_MAX = 1010;
const int16_t eurexEnterTESTradeRequestPacket::TRD_TYPE_NO_VALUE = 0xFFFF;
const int8_t eurexEnterTESTradeRequestPacket::PRODUCT_COMPLEX_MIN = 1;
const int8_t eurexEnterTESTradeRequestPacket::PRODUCT_COMPLEX_MAX = 10;
const int8_t eurexEnterTESTradeRequestPacket::PRODUCT_COMPLEX_NO_VALUE = 0xFF;
const int8_t eurexEnterTESTradeRequestPacket::TRADE_REPORT_TYPE_MIN = 0;
const int8_t eurexEnterTESTradeRequestPacket::TRADE_REPORT_TYPE_MAX = 13;
const int8_t eurexEnterTESTradeRequestPacket::TRADE_REPORT_TYPE_NO_VALUE = 0xFF;
const int8_t eurexEnterTESTradeRequestPacket::TRADE_PUBLISH_INDICATOR_MIN = 0;
const int8_t eurexEnterTESTradeRequestPacket::TRADE_PUBLISH_INDICATOR_MAX = 3;
const int8_t eurexEnterTESTradeRequestPacket::TRADE_PUBLISH_INDICATOR_NO_VALUE = 0xFF;
const int8_t eurexEnterTESTradeRequestPacket::NO_SIDE_ALLOCS_MIN = 1;
const int8_t eurexEnterTESTradeRequestPacket::NO_SIDE_ALLOCS_MAX = 30;
const int8_t eurexEnterTESTradeRequestPacket::NO_SIDE_ALLOCS_NO_VALUE = 0xFF;
const int8_t eurexEnterTESTradeRequestPacket::NO_EVENTS_MIN = 0;
const int8_t eurexEnterTESTradeRequestPacket::NO_EVENTS_MAX = 2;
const int8_t eurexEnterTESTradeRequestPacket::NO_EVENTS_NO_VALUE = 0xFF;
const int8_t eurexEnterTESTradeRequestPacket::NO_LEGS_MIN = 0;
const int8_t eurexEnterTESTradeRequestPacket::NO_LEGS_MAX = 20;
const int8_t eurexEnterTESTradeRequestPacket::NO_LEGS_NO_VALUE = 0xFF;
const int8_t eurexEnterTESTradeRequestPacket::NO_INSTR_ATTRIB_MIN = 0;
const int8_t eurexEnterTESTradeRequestPacket::NO_INSTR_ATTRIB_MAX = 6;
const int8_t eurexEnterTESTradeRequestPacket::NO_INSTR_ATTRIB_NO_VALUE = 0xFF;
const int8_t eurexEnterTESTradeRequestPacket::NO_UNDERLYING_STIPS_MIN = 0;
const int8_t eurexEnterTESTradeRequestPacket::NO_UNDERLYING_STIPS_MAX = 1;
const int8_t eurexEnterTESTradeRequestPacket::NO_UNDERLYING_STIPS_NO_VALUE = 0xFF;
const int8_t eurexEnterTESTradeRequestPacket::PARTY_IDSETTLEMENT_LOCATION_MIN = 1;
const int8_t eurexEnterTESTradeRequestPacket::PARTY_IDSETTLEMENT_LOCATION_MAX = 4;
const int8_t eurexEnterTESTradeRequestPacket::PARTY_IDSETTLEMENT_LOCATION_NO_VALUE = 0xFF;
const int8_t eurexEnterTESTradeRequestPacket::HEDGE_TYPE_MIN = 0;
const int8_t eurexEnterTESTradeRequestPacket::HEDGE_TYPE_MAX = 2;
const int8_t eurexEnterTESTradeRequestPacket::HEDGE_TYPE_NO_VALUE = 0xFF;
const char eurexEnterTESTradeRequestPacket::TRADE_REPORT_TEXT_NO_VALUE[20] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexEnterTESTradeRequestPacket::TRADE_REPORT_TEXT_MAX_LENGTH = 20;
const char eurexEnterTESTradeRequestPacket::TRADE_REPORT_ID_NO_VALUE[20] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexEnterTESTradeRequestPacket::TRADE_REPORT_ID_MAX_LENGTH = 20;
const char eurexEnterTESTradeRequestPacket::UNDERLYING_SECURITY_ID_NO_VALUE[12] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexEnterTESTradeRequestPacket::UNDERLYING_SECURITY_ID_MAX_LENGTH = 12;
const char eurexEnterTESTradeRequestPacket::UNDERLYING_SECURITY_DESC_NO_VALUE[30] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexEnterTESTradeRequestPacket::UNDERLYING_SECURITY_DESC_MAX_LENGTH = 30;
const char eurexEnterTESTradeRequestPacket::UNDERLYING_CURRENCY_NO_VALUE[3] = {0x00, 0x00, 0x00};
const size_t eurexEnterTESTradeRequestPacket::UNDERLYING_CURRENCY_MAX_LENGTH = 3;
const char eurexEnterTESTradeRequestPacket::UNDERLYING_ISSUER_NO_VALUE[30] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexEnterTESTradeRequestPacket::UNDERLYING_ISSUER_MAX_LENGTH = 30;
const char eurexEnterTESTradeRequestPacket::PAD7_NO_VALUE[7] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexEnterTESTradeRequestPacket::PAD7_MAX_LENGTH = 7;
const size_t eurexEnterTESTradeRequestPacket::SIDE_ALLOC_GRP_MIN = 1;
const size_t eurexEnterTESTradeRequestPacket::SIDE_ALLOC_GRP_MAX = 30;
const size_t eurexEnterTESTradeRequestPacket::TRD_INSTRMNT_LEG_GRP_MIN = 0;
const size_t eurexEnterTESTradeRequestPacket::TRD_INSTRMNT_LEG_GRP_MAX = 20;
const size_t eurexEnterTESTradeRequestPacket::INSTRUMENT_EVENT_GRP_MIN = 0;
const size_t eurexEnterTESTradeRequestPacket::INSTRUMENT_EVENT_GRP_MAX = 2;
const size_t eurexEnterTESTradeRequestPacket::INSTRUMENT_ATTRIBUTE_GRP_MIN = 0;
const size_t eurexEnterTESTradeRequestPacket::INSTRUMENT_ATTRIBUTE_GRP_MAX = 6;
const size_t eurexEnterTESTradeRequestPacket::SRQSRELATED_TRADE_IDGRP_MIN = 0;
const size_t eurexEnterTESTradeRequestPacket::SRQSRELATED_TRADE_IDGRP_MAX = 12;


} // namespace neueda

#endif // EUREX_ENTERTESTRADEREQUEST_PACKET_H
