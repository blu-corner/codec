 ...
 */
#ifndef EUREX_USERLOGOUTREQUEST_PACKET_H
#define EUREX_USERLOGOUTREQUEST_PACKET_H
...
class eurexUserLogoutRequestPacket
{
    public:
        // no value constants
...
const int32_t eurexUserLogoutRequestPacket::USERNAME_MIN = 0;
const int32_t eurexUserLogoutRequestPacket::USERNAME_MAX = 2147483647;
const int32_t eurexUserLogoutRequestPacket::USERNAME_NO_VALUE = 0xFFFFFFFF;
const char eurexUserLogoutRequestPacket::PAD4_NO_VALUE[4] = {0x00, 0x00, 0x00, 0x00};
const size_t eurexUserLogoutRequestPacket::PAD4_MAX_LENGTH = 4;


} // namespace neueda

#endif // EUREX_USERLOGOUTREQUEST_PACKET_H
