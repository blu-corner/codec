 ...
 */
#ifndef EUREX_DELETEORDERNRRESPONSE_PACKET_H
#define EUREX_DELETEORDERNRRESPONSE_PACKET_H
...
class eurexDeleteOrderNRResponsePacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexDeleteOrderNRResponsePacket ()
        {
...
const uint64_t eurexDeleteOrderNRResponsePacket::ORDER_ID_MIN = 0UL;
const uint64_t eurexDeleteOrderNRResponsePacket::ORDER_ID_MAX = 18446744073709551614UL;
const uint64_t eurexDeleteOrderNRResponsePacket::ORDER_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexDeleteOrderNRResponsePacket::CL_ORD_ID_MIN = 0UL;
const uint64_t eurexDeleteOrderNRResponsePacket::CL_ORD_ID_MAX = 18446744073709551614UL;
const uint64_t eurexDeleteOrderNRResponsePacket::CL_ORD_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexDeleteOrderNRResponsePacket::ORIG_CL_ORD_ID_MIN = 0UL;
const uint64_t eurexDeleteOrderNRResponsePacket::ORIG_CL_ORD_ID_MAX = 18446744073709551614UL;
const uint64_t eurexDeleteOrderNRResponsePacket::ORIG_CL_ORD_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const int64_t eurexDeleteOrderNRResponsePacket::SECURITY_ID_MIN = -9223372036854775807L;
const int64_t eurexDeleteOrderNRResponsePacket::SECURITY_ID_MAX = 9223372036854775807L;
const int64_t eurexDeleteOrderNRResponsePacket::SECURITY_ID_NO_VALUE = 0x8000000000000000;
const uint64_t eurexDeleteOrderNRResponsePacket::EXEC_ID_MIN = 0UL;
const uint64_t eurexDeleteOrderNRResponsePacket::EXEC_ID_MAX = 18446744073709551614UL;
const uint64_t eurexDeleteOrderNRResponsePacket::EXEC_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const double eurexDeleteOrderNRResponsePacket::CUM_QTY_MIN = -922337203685477.5807;
const double eurexDeleteOrderNRResponsePacket::CUM_QTY_MAX = 922337203685477.5807;
const int64_t eurexDeleteOrderNRResponsePacket::CUM_QTY_NO_VALUE = 0x8000000000000000;
const double eurexDeleteOrderNRResponsePacket::CXL_QTY_MIN = -922337203685477.5807;
const double eurexDeleteOrderNRResponsePacket::CXL_QTY_MAX = 922337203685477.5807;
const int64_t eurexDeleteOrderNRResponsePacket::CXL_QTY_NO_VALUE = 0x8000000000000000;
const char eurexDeleteOrderNRResponsePacket::ORD_STATUS_NO_VALUE[1] = {0x00};
const size_t eurexDeleteOrderNRResponsePacket::ORD_STATUS_MAX_LENGTH = 1;
const char eurexDeleteOrderNRResponsePacket::EXEC_TYPE_NO_VALUE[1] = {0x00};
const size_t eurexDeleteOrderNRResponsePacket::EXEC_TYPE_MAX_LENGTH = 1;
const int16_t eurexDeleteOrderNRResponsePacket::EXEC_RESTATEMENT_REASON_MIN = 0;
const int16_t eurexDeleteOrderNRResponsePacket::EXEC_RESTATEMENT_REASON_MAX = 344;
const int16_t eurexDeleteOrderNRResponsePacket::EXEC_RESTATEMENT_REASON_NO_VALUE = 0xFFFF;
const int8_t eurexDeleteOrderNRResponsePacket::PRODUCT_COMPLEX_MIN = 1;
const int8_t eurexDeleteOrderNRResponsePacket::PRODUCT_COMPLEX_MAX = 10;
const int8_t eurexDeleteOrderNRResponsePacket::PRODUCT_COMPLEX_NO_VALUE = 0xFF;
const int8_t eurexDeleteOrderNRResponsePacket::TRANSACTION_DELAY_INDICATOR_MIN = 0;
const int8_t eurexDeleteOrderNRResponsePacket::TRANSACTION_DELAY_INDICATOR_MAX = 1;
const int8_t eurexDeleteOrderNRResponsePacket::TRANSACTION_DELAY_INDICATOR_NO_VALUE = 0xFF;
const char eurexDeleteOrderNRResponsePacket::PAD2_NO_VALUE[2] = {0x00, 0x00};
const size_t eurexDeleteOrderNRResponsePacket::PAD2_MAX_LENGTH = 2;


} // namespace neueda

#endif // EUREX_DELETEORDERNRRESPONSE_PACKET_H
