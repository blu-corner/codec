 ...
 */
#ifndef EUREX_NOTAFFECTEDSECURITIESGRPCOMP_PACKET_H
#define EUREX_NOTAFFECTEDSECURITIESGRPCOMP_PACKET_H
...
class eurexNotAffectedSecuritiesGrpCompPacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexNotAffectedSecuritiesGrpCompPacket ()
        {
        ...
        {
            codecState state;
            state = eurex::serialize (mNotAffectedSecurityID, buf, len, used);
        ...
        {
            codecState state;
            state = eurex::deserialize (mNotAffectedSecurityID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            return GW_CODEC_SUCCESS;
        }
...
const uint64_t eurexNotAffectedSecuritiesGrpCompPacket::NOT_AFFECTED_SECURITY_ID_MIN = 0UL;
const uint64_t eurexNotAffectedSecuritiesGrpCompPacket::NOT_AFFECTED_SECURITY_ID_MAX = 18446744073709551614UL;
const uint64_t eurexNotAffectedSecuritiesGrpCompPacket::NOT_AFFECTED_SECURITY_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;


} // namespace neueda

#endif // EUREX_NOTAFFECTEDSECURITIESGRPCOMP_PACKET_H
