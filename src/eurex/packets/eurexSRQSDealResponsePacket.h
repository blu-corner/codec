 ...
 */
#ifndef EUREX_SRQSDEALRESPONSE_PACKET_H
#define EUREX_SRQSDEALRESPONSE_PACKET_H
...
class eurexSRQSDealResponsePacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexSRQSDealResponsePacket ()
        {
            mMessageHeaderOut.mTemplateID = 10705;
        ...
        codecState serialize (void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mSecondaryTradeID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        codecState deserialize (const void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mSecondaryTradeID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
...
const int64_t eurexSRQSDealResponsePacket::SECURITY_ID_MIN = -9223372036854775807L;
const int64_t eurexSRQSDealResponsePacket::SECURITY_ID_MAX = 9223372036854775807L;
const int64_t eurexSRQSDealResponsePacket::SECURITY_ID_NO_VALUE = 0x8000000000000000;
const uint64_t eurexSRQSDealResponsePacket::QUOTE_ID_MIN = 0UL;
const uint64_t eurexSRQSDealResponsePacket::QUOTE_ID_MAX = 18446744073709551614UL;
const uint64_t eurexSRQSDealResponsePacket::QUOTE_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint32_t eurexSRQSDealResponsePacket::NEGOTIATION_ID_MIN = 0;
const uint32_t eurexSRQSDealResponsePacket::NEGOTIATION_ID_MAX = 4294967294;
const uint32_t eurexSRQSDealResponsePacket::NEGOTIATION_ID_NO_VALUE = 0xFFFFFFFF;
const uint32_t eurexSRQSDealResponsePacket::TRADE_ID_MIN = 0;
const uint32_t eurexSRQSDealResponsePacket::TRADE_ID_MAX = 4294967294;
const uint32_t eurexSRQSDealResponsePacket::TRADE_ID_NO_VALUE = 0xFFFFFFFF;
const uint32_t eurexSRQSDealResponsePacket::SECONDARY_TRADE_ID_MIN = 0;
const uint32_t eurexSRQSDealResponsePacket::SECONDARY_TRADE_ID_MAX = 4294967294;
const uint32_t eurexSRQSDealResponsePacket::SECONDARY_TRADE_ID_NO_VALUE = 0xFFFFFFFF;
const char eurexSRQSDealResponsePacket::FIRM_TRADE_ID_NO_VALUE[20] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexSRQSDealResponsePacket::FIRM_TRADE_ID_MAX_LENGTH = 20;
const char eurexSRQSDealResponsePacket::FIRM_NEGOTIATION_ID_NO_VALUE[20] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexSRQSDealResponsePacket::FIRM_NEGOTIATION_ID_MAX_LENGTH = 20;
const char eurexSRQSDealResponsePacket::PAD4_NO_VALUE[4] = {0x00, 0x00, 0x00, 0x00};
const size_t eurexSRQSDealResponsePacket::PAD4_MAX_LENGTH = 4;


} // namespace neueda

#endif // EUREX_SRQSDEALRESPONSE_PACKET_H
