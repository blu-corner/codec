 ...
 */
#ifndef EUREX_LOGOUTREQUEST_PACKET_H
#define EUREX_LOGOUTREQUEST_PACKET_H
...
class eurexLogoutRequestPacket
{
    public:
        // no value constants
...
#endif // EUREX_LOGOUTREQUEST_PACKET_H
