    ...
    public:
        ...
        size_t getRawSize () const
        {
            size_t result = mMessageHeaderIn.getRawSize()
                ...
                + sizeof (mPad1)
                + eurex::getRawSize (mRiskLimitQtyGrp);
            return result;
        }
        ...
        codecState serialize (void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mNoRiskLimitsQty, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        codecState deserialize (const void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mNoRiskLimitsQty, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        string toString () const
        {
            ...
            sss << "PreTradeRiskLimitsDefinitionRequest::"
                ...
                << "[Pad1=" << getPad1 () << "],"
                << "[RiskLimitQtyGrp=" << eurex::toString (getRiskLimitQtyGrp ()) << "]";
            return sss.str();
        }
};
