 ...
 */
#ifndef EUREX_DELETEALLQUOTEBROADCAST_PACKET_H
#define EUREX_DELETEALLQUOTEBROADCAST_PACKET_H
...
class eurexDeleteAllQuoteBroadcastPacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexDeleteAllQuoteBroadcastPacket ()
        {
        ...
        codecState serialize (void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mTargetPartyIDDeskID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        codecState deserialize (const void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mTargetPartyIDDeskID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
...
const uint64_t eurexDeleteAllQuoteBroadcastPacket::MASS_ACTION_REPORT_ID_MIN = 0UL;
const uint64_t eurexDeleteAllQuoteBroadcastPacket::MASS_ACTION_REPORT_ID_MAX = 18446744073709551614UL;
const uint64_t eurexDeleteAllQuoteBroadcastPacket::MASS_ACTION_REPORT_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const int64_t eurexDeleteAllQuoteBroadcastPacket::SECURITY_ID_MIN = -9223372036854775807L;
const int64_t eurexDeleteAllQuoteBroadcastPacket::SECURITY_ID_MAX = 9223372036854775807L;
const int64_t eurexDeleteAllQuoteBroadcastPacket::SECURITY_ID_NO_VALUE = 0x8000000000000000;
const int32_t eurexDeleteAllQuoteBroadcastPacket::MARKET_SEGMENT_ID_MIN = -2147483647;
const int32_t eurexDeleteAllQuoteBroadcastPacket::MARKET_SEGMENT_ID_MAX = 2147483647;
const int32_t eurexDeleteAllQuoteBroadcastPacket::MARKET_SEGMENT_ID_NO_VALUE = 0x80000000;
const uint32_t eurexDeleteAllQuoteBroadcastPacket::TARGET_PARTY_IDSESSION_ID_MIN = 0;
const uint32_t eurexDeleteAllQuoteBroadcastPacket::TARGET_PARTY_IDSESSION_ID_MAX = 4294967294;
const uint32_t eurexDeleteAllQuoteBroadcastPacket::TARGET_PARTY_IDSESSION_ID_NO_VALUE = 0xFFFFFFFF;
const uint32_t eurexDeleteAllQuoteBroadcastPacket::PARTY_IDENTERING_TRADER_MIN = 0;
const uint32_t eurexDeleteAllQuoteBroadcastPacket::PARTY_IDENTERING_TRADER_MAX = 4294967294;
const uint32_t eurexDeleteAllQuoteBroadcastPacket::PARTY_IDENTERING_TRADER_NO_VALUE = 0xFFFFFFFF;
const int32_t eurexDeleteAllQuoteBroadcastPacket::TARGET_PARTY_IDEXECUTING_TRADER_MIN = 0;
const int32_t eurexDeleteAllQuoteBroadcastPacket::TARGET_PARTY_IDEXECUTING_TRADER_MAX = 2147483647;
const int32_t eurexDeleteAllQuoteBroadcastPacket::TARGET_PARTY_IDEXECUTING_TRADER_NO_VALUE = 0xFFFFFFFF;
const int16_t eurexDeleteAllQuoteBroadcastPacket::NO_NOT_AFFECTED_SECURITIES_MIN = 0;
const int16_t eurexDeleteAllQuoteBroadcastPacket::NO_NOT_AFFECTED_SECURITIES_MAX = 500;
const int16_t eurexDeleteAllQuoteBroadcastPacket::NO_NOT_AFFECTED_SECURITIES_NO_VALUE = 0xFFFF;
const uint8_t eurexDeleteAllQuoteBroadcastPacket::MASS_ACTION_REASON_MIN = 0;
const uint8_t eurexDeleteAllQuoteBroadcastPacket::MASS_ACTION_REASON_MAX = 200;
const uint8_t eurexDeleteAllQuoteBroadcastPacket::MASS_ACTION_REASON_NO_VALUE = 0xFF;
const int8_t eurexDeleteAllQuoteBroadcastPacket::PARTY_IDENTERING_FIRM_MIN = 1;
const int8_t eurexDeleteAllQuoteBroadcastPacket::PARTY_IDENTERING_FIRM_MAX = 2;
const int8_t eurexDeleteAllQuoteBroadcastPacket::PARTY_IDENTERING_FIRM_NO_VALUE = 0xFF;
const char eurexDeleteAllQuoteBroadcastPacket::TARGET_PARTY_IDDESK_ID_NO_VALUE[3] = {0x00, 0x00, 0x00};
const size_t eurexDeleteAllQuoteBroadcastPacket::TARGET_PARTY_IDDESK_ID_MAX_LENGTH = 3;
const char eurexDeleteAllQuoteBroadcastPacket::PAD1_NO_VALUE[1] = {0x00};
const size_t eurexDeleteAllQuoteBroadcastPacket::PAD1_MAX_LENGTH = 1;
const size_t eurexDeleteAllQuoteBroadcastPacket::NOT_AFFECTED_SECURITIES_GRP_MIN = 0;
const size_t eurexDeleteAllQuoteBroadcastPacket::NOT_AFFECTED_SECURITIES_GRP_MAX = 500;


} // namespace neueda

#endif // EUREX_DELETEALLQUOTEBROADCAST_PACKET_H
