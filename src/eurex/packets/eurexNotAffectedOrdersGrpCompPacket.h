...
class eurexNotAffectedOrdersGrpCompPacket
{
    public:
        ...
        {
            codecState state;
            state = eurex::serialize (mNotAffectedOrderID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mNotAffOrigClOrdID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        {
            codecState state;
            state = eurex::deserialize (mNotAffectedOrderID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mNotAffOrigClOrdID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            return GW_CODEC_SUCCESS;
        }
