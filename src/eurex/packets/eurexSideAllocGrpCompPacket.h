 ...
 */
#ifndef EUREX_SIDEALLOCGRPCOMP_PACKET_H
#define EUREX_SIDEALLOCGRPCOMP_PACKET_H
...
class eurexSideAllocGrpCompPacket
{
    public:
        // no value constants
        ...
        codecState serialize (void *buf, size_t len, size_t &used)
        {
            ...
            state = eurex::serialize (mIndividualAllocID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        codecState deserialize (const void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mIndividualAllocID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
...
const double eurexSideAllocGrpCompPacket::ALLOC_QTY_MIN = -922337203685477.5807;
const double eurexSideAllocGrpCompPacket::ALLOC_QTY_MAX = 922337203685477.5807;
const int64_t eurexSideAllocGrpCompPacket::ALLOC_QTY_NO_VALUE = 0x8000000000000000;
const uint32_t eurexSideAllocGrpCompPacket::INDIVIDUAL_ALLOC_ID_MIN = 0;
const uint32_t eurexSideAllocGrpCompPacket::INDIVIDUAL_ALLOC_ID_MAX = 4294967294;
const uint32_t eurexSideAllocGrpCompPacket::INDIVIDUAL_ALLOC_ID_NO_VALUE = 0xFFFFFFFF;
const int8_t eurexSideAllocGrpCompPacket::SIDE_MIN = 1;
const int8_t eurexSideAllocGrpCompPacket::SIDE_MAX = 2;
const int8_t eurexSideAllocGrpCompPacket::SIDE_NO_VALUE = 0xFF;
const char eurexSideAllocGrpCompPacket::PARTY_EXECUTING_FIRM_NO_VALUE[5] = {0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexSideAllocGrpCompPacket::PARTY_EXECUTING_FIRM_MAX_LENGTH = 5;
const char eurexSideAllocGrpCompPacket::PARTY_EXECUTING_TRADER_NO_VALUE[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexSideAllocGrpCompPacket::PARTY_EXECUTING_TRADER_MAX_LENGTH = 6;


} // namespace neueda

#endif // EUREX_SIDEALLOCGRPCOMP_PACKET_H
