 ...
 */
#ifndef EUREX_DELETEALLORDERREQUEST_PACKET_H
#define EUREX_DELETEALLORDERREQUEST_PACKET_H
...
class eurexDeleteAllOrderRequestPacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexDeleteAllOrderRequestPacket ()
        {
...
const int64_t eurexDeleteAllOrderRequestPacket::SECURITY_ID_MIN = -9223372036854775807L;
const int64_t eurexDeleteAllOrderRequestPacket::SECURITY_ID_MAX = 9223372036854775807L;
const int64_t eurexDeleteAllOrderRequestPacket::SECURITY_ID_NO_VALUE = 0x8000000000000000;
const double eurexDeleteAllOrderRequestPacket::PRICE_MIN = -92233720368.54775807;
const double eurexDeleteAllOrderRequestPacket::PRICE_MAX = 92233720368.54775807;
const int64_t eurexDeleteAllOrderRequestPacket::PRICE_NO_VALUE = 0x8000000000000000;
const uint64_t eurexDeleteAllOrderRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_MIN = 0UL;
const uint64_t eurexDeleteAllOrderRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_MAX = 18446744073709551614UL;
const uint64_t eurexDeleteAllOrderRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexDeleteAllOrderRequestPacket::EXECUTING_TRADER_MIN = 0UL;
const uint64_t eurexDeleteAllOrderRequestPacket::EXECUTING_TRADER_MAX = 18446744073709551614UL;
const uint64_t eurexDeleteAllOrderRequestPacket::EXECUTING_TRADER_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const int32_t eurexDeleteAllOrderRequestPacket::MARKET_SEGMENT_ID_MIN = -2147483647;
const int32_t eurexDeleteAllOrderRequestPacket::MARKET_SEGMENT_ID_MAX = 2147483647;
const int32_t eurexDeleteAllOrderRequestPacket::MARKET_SEGMENT_ID_NO_VALUE = 0x80000000;
const uint32_t eurexDeleteAllOrderRequestPacket::TARGET_PARTY_IDSESSION_ID_MIN = 0;
const uint32_t eurexDeleteAllOrderRequestPacket::TARGET_PARTY_IDSESSION_ID_MAX = 4294967294;
const uint32_t eurexDeleteAllOrderRequestPacket::TARGET_PARTY_IDSESSION_ID_NO_VALUE = 0xFFFFFFFF;
const int32_t eurexDeleteAllOrderRequestPacket::TARGET_PARTY_IDEXECUTING_TRADER_MIN = 0;
const int32_t eurexDeleteAllOrderRequestPacket::TARGET_PARTY_IDEXECUTING_TRADER_MAX = 2147483647;
const int32_t eurexDeleteAllOrderRequestPacket::TARGET_PARTY_IDEXECUTING_TRADER_NO_VALUE = 0xFFFFFFFF;
const int8_t eurexDeleteAllOrderRequestPacket::SIDE_MIN = 1;
const int8_t eurexDeleteAllOrderRequestPacket::SIDE_MAX = 2;
const int8_t eurexDeleteAllOrderRequestPacket::SIDE_NO_VALUE = 0xFF;
const int8_t eurexDeleteAllOrderRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_MIN = 22;
const int8_t eurexDeleteAllOrderRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_MAX = 24;
const int8_t eurexDeleteAllOrderRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_NO_VALUE = 0xFF;
const int8_t eurexDeleteAllOrderRequestPacket::EXECUTING_TRADER_QUALIFIER_MIN = 22;
const int8_t eurexDeleteAllOrderRequestPacket::EXECUTING_TRADER_QUALIFIER_MAX = 24;
const int8_t eurexDeleteAllOrderRequestPacket::EXECUTING_TRADER_QUALIFIER_NO_VALUE = 0xFF;
const char eurexDeleteAllOrderRequestPacket::PAD1_NO_VALUE[1] = {0x00};
const size_t eurexDeleteAllOrderRequestPacket::PAD1_MAX_LENGTH = 1;


} // namespace neueda

#endif // EUREX_DELETEALLORDERREQUEST_PACKET_H
