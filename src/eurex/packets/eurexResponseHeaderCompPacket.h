 ...
 */
#ifndef EUREX_RESPONSEHEADERCOMP_PACKET_H
#define EUREX_RESPONSEHEADERCOMP_PACKET_H
...
class eurexResponseHeaderCompPacket
{
    public:
        // no value constants
...
const uint64_t eurexResponseHeaderCompPacket::REQUEST_TIME_MIN = 0UL;
const uint64_t eurexResponseHeaderCompPacket::REQUEST_TIME_MAX = 18446744073709551614UL;
const uint64_t eurexResponseHeaderCompPacket::REQUEST_TIME_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexResponseHeaderCompPacket::SENDING_TIME_MIN = 0UL;
const uint64_t eurexResponseHeaderCompPacket::SENDING_TIME_MAX = 18446744073709551614UL;
const uint64_t eurexResponseHeaderCompPacket::SENDING_TIME_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint32_t eurexResponseHeaderCompPacket::MSG_SEQ_NUM_MIN = 0;
const uint32_t eurexResponseHeaderCompPacket::MSG_SEQ_NUM_MAX = 4294967294;
const uint32_t eurexResponseHeaderCompPacket::MSG_SEQ_NUM_NO_VALUE = 0xFFFFFFFF;
const char eurexResponseHeaderCompPacket::PAD4_NO_VALUE[4] = {0x00, 0x00, 0x00, 0x00};
const size_t eurexResponseHeaderCompPacket::PAD4_MAX_LENGTH = 4;


} // namespace neueda

#endif // EUREX_RESPONSEHEADERCOMP_PACKET_H
