 ...
 */
#ifndef EUREX_RETRANSMITREQUEST_PACKET_H
#define EUREX_RETRANSMITREQUEST_PACKET_H
...
class eurexRetransmitRequestPacket
{
    public:
        // no value constants
        ...
        codecState serialize (void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mApplBegSeqNum, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mApplEndSeqNum, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        codecState deserialize (const void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mApplBegSeqNum, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mApplEndSeqNum, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
...
const uint64_t eurexRetransmitRequestPacket::APPL_BEG_SEQ_NUM_MIN = 0UL;
const uint64_t eurexRetransmitRequestPacket::APPL_BEG_SEQ_NUM_MAX = 18446744073709551614UL;
const uint64_t eurexRetransmitRequestPacket::APPL_BEG_SEQ_NUM_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexRetransmitRequestPacket::APPL_END_SEQ_NUM_MIN = 0UL;
const uint64_t eurexRetransmitRequestPacket::APPL_END_SEQ_NUM_MAX = 18446744073709551614UL;
const uint64_t eurexRetransmitRequestPacket::APPL_END_SEQ_NUM_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint16_t eurexRetransmitRequestPacket::PARTITION_ID_MIN = 0;
const uint16_t eurexRetransmitRequestPacket::PARTITION_ID_MAX = 65534;
const uint16_t eurexRetransmitRequestPacket::PARTITION_ID_NO_VALUE = 0xFFFF;
const int8_t eurexRetransmitRequestPacket::REF_APPL_ID_MIN = 0;
const int8_t eurexRetransmitRequestPacket::REF_APPL_ID_MAX = 10;
const int8_t eurexRetransmitRequestPacket::REF_APPL_ID_NO_VALUE = 0xFF;
const char eurexRetransmitRequestPacket::PAD5_NO_VALUE[5] = {0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexRetransmitRequestPacket::PAD5_MAX_LENGTH = 5;


} // namespace neueda

#endif // EUREX_RETRANSMITREQUEST_PACKET_H
