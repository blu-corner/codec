...
class eurexUnderlyingStipGrpCompPacket
{
    public:
        ...
        {
            codecState state;
            state = eurex::serialize (mUnderlyingStipValue, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mUnderlyingStipType, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        {
            codecState state;
            state = eurex::deserialize (mUnderlyingStipValue, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mUnderlyingStipType, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
