 ...
 */
#ifndef EUREX_MODIFYORDERRESPONSE_PACKET_H
#define EUREX_MODIFYORDERRESPONSE_PACKET_H
...
class eurexModifyOrderResponsePacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexModifyOrderResponsePacket ()
        {
...
const uint64_t eurexModifyOrderResponsePacket::ORDER_ID_MIN = 0UL;
const uint64_t eurexModifyOrderResponsePacket::ORDER_ID_MAX = 18446744073709551614UL;
const uint64_t eurexModifyOrderResponsePacket::ORDER_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexModifyOrderResponsePacket::CL_ORD_ID_MIN = 0UL;
const uint64_t eurexModifyOrderResponsePacket::CL_ORD_ID_MAX = 18446744073709551614UL;
const uint64_t eurexModifyOrderResponsePacket::CL_ORD_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexModifyOrderResponsePacket::ORIG_CL_ORD_ID_MIN = 0UL;
const uint64_t eurexModifyOrderResponsePacket::ORIG_CL_ORD_ID_MAX = 18446744073709551614UL;
const uint64_t eurexModifyOrderResponsePacket::ORIG_CL_ORD_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const int64_t eurexModifyOrderResponsePacket::SECURITY_ID_MIN = -9223372036854775807L;
const int64_t eurexModifyOrderResponsePacket::SECURITY_ID_MAX = 9223372036854775807L;
const int64_t eurexModifyOrderResponsePacket::SECURITY_ID_NO_VALUE = 0x8000000000000000;
const uint64_t eurexModifyOrderResponsePacket::EXEC_ID_MIN = 0UL;
const uint64_t eurexModifyOrderResponsePacket::EXEC_ID_MAX = 18446744073709551614UL;
const uint64_t eurexModifyOrderResponsePacket::EXEC_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const double eurexModifyOrderResponsePacket::LEAVES_QTY_MIN = -922337203685477.5807;
const double eurexModifyOrderResponsePacket::LEAVES_QTY_MAX = 922337203685477.5807;
const int64_t eurexModifyOrderResponsePacket::LEAVES_QTY_NO_VALUE = 0x8000000000000000;
const double eurexModifyOrderResponsePacket::CUM_QTY_MIN = -922337203685477.5807;
const double eurexModifyOrderResponsePacket::CUM_QTY_MAX = 922337203685477.5807;
const int64_t eurexModifyOrderResponsePacket::CUM_QTY_NO_VALUE = 0x8000000000000000;
const double eurexModifyOrderResponsePacket::CXL_QTY_MIN = -922337203685477.5807;
const double eurexModifyOrderResponsePacket::CXL_QTY_MAX = 922337203685477.5807;
const int64_t eurexModifyOrderResponsePacket::CXL_QTY_NO_VALUE = 0x8000000000000000;
const uint64_t eurexModifyOrderResponsePacket::TRD_REG_TSTIME_PRIORITY_MIN = 0UL;
const uint64_t eurexModifyOrderResponsePacket::TRD_REG_TSTIME_PRIORITY_MAX = 18446744073709551614UL;
const uint64_t eurexModifyOrderResponsePacket::TRD_REG_TSTIME_PRIORITY_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const char eurexModifyOrderResponsePacket::ORD_STATUS_NO_VALUE[1] = {0x00};
const size_t eurexModifyOrderResponsePacket::ORD_STATUS_MAX_LENGTH = 1;
const char eurexModifyOrderResponsePacket::EXEC_TYPE_NO_VALUE[1] = {0x00};
const size_t eurexModifyOrderResponsePacket::EXEC_TYPE_MAX_LENGTH = 1;
const int16_t eurexModifyOrderResponsePacket::EXEC_RESTATEMENT_REASON_MIN = 0;
const int16_t eurexModifyOrderResponsePacket::EXEC_RESTATEMENT_REASON_MAX = 344;
const int16_t eurexModifyOrderResponsePacket::EXEC_RESTATEMENT_REASON_NO_VALUE = 0xFFFF;
const int8_t eurexModifyOrderResponsePacket::CROSSED_INDICATOR_MIN = 0;
const int8_t eurexModifyOrderResponsePacket::CROSSED_INDICATOR_MAX = 1;
const int8_t eurexModifyOrderResponsePacket::CROSSED_INDICATOR_NO_VALUE = 0xFF;
const int8_t eurexModifyOrderResponsePacket::PRODUCT_COMPLEX_MIN = 1;
const int8_t eurexModifyOrderResponsePacket::PRODUCT_COMPLEX_MAX = 10;
const int8_t eurexModifyOrderResponsePacket::PRODUCT_COMPLEX_NO_VALUE = 0xFF;
const int8_t eurexModifyOrderResponsePacket::TRIGGERED_MIN = 0;
const int8_t eurexModifyOrderResponsePacket::TRIGGERED_MAX = 2;
const int8_t eurexModifyOrderResponsePacket::TRIGGERED_NO_VALUE = 0xFF;
const int8_t eurexModifyOrderResponsePacket::TRANSACTION_DELAY_INDICATOR_MIN = 0;
const int8_t eurexModifyOrderResponsePacket::TRANSACTION_DELAY_INDICATOR_MAX = 1;
const int8_t eurexModifyOrderResponsePacket::TRANSACTION_DELAY_INDICATOR_NO_VALUE = 0xFF;


} // namespace neueda

#endif // EUREX_MODIFYORDERRESPONSE_PACKET_H
