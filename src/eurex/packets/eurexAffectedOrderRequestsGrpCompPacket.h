 ...
 */
#ifndef EUREX_AFFECTEDORDERREQUESTSGRPCOMP_PACKET_H
#define EUREX_AFFECTEDORDERREQUESTSGRPCOMP_PACKET_H
...
class eurexAffectedOrderRequestsGrpCompPacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexAffectedOrderRequestsGrpCompPacket ()
        {
        ...
        {
            codecState state;
            state = eurex::serialize (mAffectedOrderRequestID, buf, len, used);
        ...
        {
            codecState state;
            state = eurex::deserialize (mAffectedOrderRequestID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
...
const uint32_t eurexAffectedOrderRequestsGrpCompPacket::AFFECTED_ORDER_REQUEST_ID_MIN = 0;
const uint32_t eurexAffectedOrderRequestsGrpCompPacket::AFFECTED_ORDER_REQUEST_ID_MAX = 4294967294;
const uint32_t eurexAffectedOrderRequestsGrpCompPacket::AFFECTED_ORDER_REQUEST_ID_NO_VALUE = 0xFFFFFFFF;
const char eurexAffectedOrderRequestsGrpCompPacket::PAD4_NO_VALUE[4] = {0x00, 0x00, 0x00, 0x00};
const size_t eurexAffectedOrderRequestsGrpCompPacket::PAD4_MAX_LENGTH = 4;


} // namespace neueda

#endif // EUREX_AFFECTEDORDERREQUESTSGRPCOMP_PACKET_H
