 ...
 */
#ifndef EUREX_INQUIREENRICHMENTRULEIDLISTRESPONSE_PACKET_H
#define EUREX_INQUIREENRICHMENTRULEIDLISTRESPONSE_PACKET_H
...
class eurexInquireEnrichmentRuleIDListResponsePacket
{
    public:
        // no value constants
        ...
        char mPad6[6];
        vector<eurexEnrichmentRulesGrpCompPacket> mEnrichmentRulesGrp;

        // constructor
        eurexInquireEnrichmentRuleIDListResponsePacket ()
        {
        ...
        const vector<eurexEnrichmentRulesGrpCompPacket>& getEnrichmentRulesGrp () const
        {
            return mEnrichmentRulesGrp;
        }

        bool setEnrichmentRulesGrp (const vector<eurexEnrichmentRulesGrpCompPacket>& v)
        {
        ...
        size_t getRawSize () const
        {
            size_t result = mMessageHeaderOut.getRawSize()
                ...
                + sizeof (mPad6)
                + eurex::getRawSize (mEnrichmentRulesGrp);
            return result;
        }
        ...
        codecState serialize (void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mNoEnrichmentRules, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        codecState deserialize (const void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mNoEnrichmentRules, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mPad6, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            mEnrichmentRulesGrp.resize (mNoEnrichmentRules);
            for (vector<eurexEnrichmentRulesGrpCompPacket>::iterator it = mEnrichmentRulesGrp.begin (); it != mEnrichmentRulesGrp.end (); ++it)
            {
        ...
        string toString () const
        {
            ...
            sss << "InquireEnrichmentRuleIDListResponse::"
                ...
                << "[Pad6=" << getPad6 () << "],"
                << "[EnrichmentRulesGrp=" << eurex::toString (getEnrichmentRulesGrp ()) << "]";
            return sss.str();
        }
};

const char eurexInquireEnrichmentRuleIDListResponsePacket::LAST_ENTITY_PROCESSED_NO_VALUE[16] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexInquireEnrichmentRuleIDListResponsePacket::LAST_ENTITY_PROCESSED_MAX_LENGTH = 16;
const int16_t eurexInquireEnrichmentRuleIDListResponsePacket::NO_ENRICHMENT_RULES_MIN = 0;
const int16_t eurexInquireEnrichmentRuleIDListResponsePacket::NO_ENRICHMENT_RULES_MAX = 400;
const int16_t eurexInquireEnrichmentRuleIDListResponsePacket::NO_ENRICHMENT_RULES_NO_VALUE = 0xFFFF;
const char eurexInquireEnrichmentRuleIDListResponsePacket::PAD6_NO_VALUE[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexInquireEnrichmentRuleIDListResponsePacket::PAD6_MAX_LENGTH = 6;
const size_t eurexInquireEnrichmentRuleIDListResponsePacket::ENRICHMENT_RULES_GRP_MIN = 0;
const size_t eurexInquireEnrichmentRuleIDListResponsePacket::ENRICHMENT_RULES_GRP_MAX = 400;


} // namespace neueda

#endif // EUREX_INQUIREENRICHMENTRULEIDLISTRESPONSE_PACKET_H
