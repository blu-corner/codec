 ...
 */
#ifndef EUREX_FORCEDUSERLOGOUTNOTIFICATION_PACKET_H
#define EUREX_FORCEDUSERLOGOUTNOTIFICATION_PACKET_H
...
class eurexForcedUserLogoutNotificationPacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexForcedUserLogoutNotificationPacket ()
        {
        ...
        codecState serialize (void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mUserStatus, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mPad3, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mUsername, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        codecState deserialize (const void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mUserStatus, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mPad3, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mUsername, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
...
const int8_t eurexForcedUserLogoutNotificationPacket::USER_STATUS_MIN = 7;
const int8_t eurexForcedUserLogoutNotificationPacket::USER_STATUS_MAX = 11;
const int8_t eurexForcedUserLogoutNotificationPacket::USER_STATUS_NO_VALUE = 0xFF;
const char eurexForcedUserLogoutNotificationPacket::PAD3_NO_VALUE[3] = {0x00, 0x00, 0x00};
const size_t eurexForcedUserLogoutNotificationPacket::PAD3_MAX_LENGTH = 3;
const int32_t eurexForcedUserLogoutNotificationPacket::USERNAME_MIN = 0;
const int32_t eurexForcedUserLogoutNotificationPacket::USERNAME_MAX = 2147483647;
const int32_t eurexForcedUserLogoutNotificationPacket::USERNAME_NO_VALUE = 0xFFFFFFFF;
const int16_t eurexForcedUserLogoutNotificationPacket::VAR_TEXT_LEN_MIN = 0;
const int16_t eurexForcedUserLogoutNotificationPacket::VAR_TEXT_LEN_MAX = 2000;
const int16_t eurexForcedUserLogoutNotificationPacket::VAR_TEXT_LEN_NO_VALUE = 0xFFFF;
const char eurexForcedUserLogoutNotificationPacket::PAD6_NO_VALUE[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexForcedUserLogoutNotificationPacket::PAD6_MAX_LENGTH = 6;
const size_t eurexForcedUserLogoutNotificationPacket::VAR_TEXT_MAX_LENGTH = 2000;


} // namespace neueda

#endif // EUREX_FORCEDUSERLOGOUTNOTIFICATION_PACKET_H
