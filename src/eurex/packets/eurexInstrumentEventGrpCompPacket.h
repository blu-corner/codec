...
class eurexInstrumentEventGrpCompPacket
{
    public:
        ...
        {
            codecState state;
            state = eurex::serialize (mEventDate, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::serialize (mEventType, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        {
            codecState state;
            state = eurex::deserialize (mEventDate, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eurex::deserialize (mEventType, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
