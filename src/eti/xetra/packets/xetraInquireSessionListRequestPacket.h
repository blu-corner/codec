 ...
 */
#ifndef XETRA_INQUIRESESSIONLISTREQUEST_PACKET_H
#define XETRA_INQUIRESESSIONLISTREQUEST_PACKET_H
...
class xetraInquireSessionListRequestPacket
{
    public:
        // no value constants
        ...
        // constructor
        xetraInquireSessionListRequestPacket ()
        {
...
#endif // XETRA_INQUIRESESSIONLISTREQUEST_PACKET_H
