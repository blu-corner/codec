 ...
 */
#ifndef XETRA_DELETEALLORDERQUOTEEVENTBROADCAST_PACKET_H
#define XETRA_DELETEALLORDERQUOTEEVENTBROADCAST_PACKET_H
...
class xetraDeleteAllOrderQuoteEventBroadcastPacket
{
    public:
        // no value constants
        ...
        // constructor
        xetraDeleteAllOrderQuoteEventBroadcastPacket ()
        {
...
const uint64_t xetraDeleteAllOrderQuoteEventBroadcastPacket::MASS_ACTION_REPORT_ID_MIN = 0UL;
const uint64_t xetraDeleteAllOrderQuoteEventBroadcastPacket::MASS_ACTION_REPORT_ID_MAX = 18446744073709551614UL;
const uint64_t xetraDeleteAllOrderQuoteEventBroadcastPacket::MASS_ACTION_REPORT_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const int64_t xetraDeleteAllOrderQuoteEventBroadcastPacket::SECURITY_ID_MIN = -9223372036854775807L;
const int64_t xetraDeleteAllOrderQuoteEventBroadcastPacket::SECURITY_ID_MAX = 9223372036854775807L;
const int64_t xetraDeleteAllOrderQuoteEventBroadcastPacket::SECURITY_ID_NO_VALUE = 0x8000000000000000;
const int32_t xetraDeleteAllOrderQuoteEventBroadcastPacket::MARKET_SEGMENT_ID_MIN = -2147483647;
const int32_t xetraDeleteAllOrderQuoteEventBroadcastPacket::MARKET_SEGMENT_ID_MAX = 2147483647;
const int32_t xetraDeleteAllOrderQuoteEventBroadcastPacket::MARKET_SEGMENT_ID_NO_VALUE = 0x80000000;
const uint8_t xetraDeleteAllOrderQuoteEventBroadcastPacket::MASS_ACTION_REASON_MIN = 0;
const uint8_t xetraDeleteAllOrderQuoteEventBroadcastPacket::MASS_ACTION_REASON_MAX = 200;
const uint8_t xetraDeleteAllOrderQuoteEventBroadcastPacket::MASS_ACTION_REASON_NO_VALUE = 0xFF;
const int8_t xetraDeleteAllOrderQuoteEventBroadcastPacket::EXEC_INST_MIN = 1;
const int8_t xetraDeleteAllOrderQuoteEventBroadcastPacket::EXEC_INST_MAX = 6;
const int8_t xetraDeleteAllOrderQuoteEventBroadcastPacket::EXEC_INST_NO_VALUE = 0xFF;
const char xetraDeleteAllOrderQuoteEventBroadcastPacket::PAD2_NO_VALUE[2] = {0x00, 0x00};
const size_t xetraDeleteAllOrderQuoteEventBroadcastPacket::PAD2_MAX_LENGTH = 2;


} // namespace neueda

#endif // XETRA_DELETEALLORDERQUOTEEVENTBROADCAST_PACKET_H
