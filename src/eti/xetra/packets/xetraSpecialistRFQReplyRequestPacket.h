 ...
 */
#ifndef XETRA_SPECIALISTRFQREPLYREQUEST_PACKET_H
#define XETRA_SPECIALISTRFQREPLYREQUEST_PACKET_H
...
class xetraSpecialistRFQReplyRequestPacket
{
    public:
        // no value constants
        ...
        // constructor
        xetraSpecialistRFQReplyRequestPacket ()
        {
            mMessageHeaderIn.mTemplateID = 10422;
...
const int64_t xetraSpecialistRFQReplyRequestPacket::SECURITY_ID_MIN = -9223372036854775807L;
const int64_t xetraSpecialistRFQReplyRequestPacket::SECURITY_ID_MAX = 9223372036854775807L;
const int64_t xetraSpecialistRFQReplyRequestPacket::SECURITY_ID_NO_VALUE = 0x8000000000000000;
const uint64_t xetraSpecialistRFQReplyRequestPacket::QUOTE_ID_MIN = 0UL;
const uint64_t xetraSpecialistRFQReplyRequestPacket::QUOTE_ID_MAX = 18446744073709551614UL;
const uint64_t xetraSpecialistRFQReplyRequestPacket::QUOTE_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const double xetraSpecialistRFQReplyRequestPacket::BID_PX_MIN = -92233720368.54775807;
const double xetraSpecialistRFQReplyRequestPacket::BID_PX_MAX = 92233720368.54775807;
const int64_t xetraSpecialistRFQReplyRequestPacket::BID_PX_NO_VALUE = 0x8000000000000000;
const double xetraSpecialistRFQReplyRequestPacket::BID_SIZE_MIN = -922337203685477.5807;
const double xetraSpecialistRFQReplyRequestPacket::BID_SIZE_MAX = 922337203685477.5807;
const int64_t xetraSpecialistRFQReplyRequestPacket::BID_SIZE_NO_VALUE = 0x8000000000000000;
const double xetraSpecialistRFQReplyRequestPacket::OFFER_PX_MIN = -92233720368.54775807;
const double xetraSpecialistRFQReplyRequestPacket::OFFER_PX_MAX = 92233720368.54775807;
const int64_t xetraSpecialistRFQReplyRequestPacket::OFFER_PX_NO_VALUE = 0x8000000000000000;
const double xetraSpecialistRFQReplyRequestPacket::OFFER_SIZE_MIN = -922337203685477.5807;
const double xetraSpecialistRFQReplyRequestPacket::OFFER_SIZE_MAX = 922337203685477.5807;
const int64_t xetraSpecialistRFQReplyRequestPacket::OFFER_SIZE_NO_VALUE = 0x8000000000000000;
const int32_t xetraSpecialistRFQReplyRequestPacket::MARKET_SEGMENT_ID_MIN = -2147483647;
const int32_t xetraSpecialistRFQReplyRequestPacket::MARKET_SEGMENT_ID_MAX = 2147483647;
const int32_t xetraSpecialistRFQReplyRequestPacket::MARKET_SEGMENT_ID_NO_VALUE = 0x80000000;
const char xetraSpecialistRFQReplyRequestPacket::PARTY_EXECUTING_FIRM_NO_VALUE[5] = {0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraSpecialistRFQReplyRequestPacket::PARTY_EXECUTING_FIRM_MAX_LENGTH = 5;
const char xetraSpecialistRFQReplyRequestPacket::PAD7_NO_VALUE[7] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraSpecialistRFQReplyRequestPacket::PAD7_MAX_LENGTH = 7;


} // namespace neueda

#endif // XETRA_SPECIALISTRFQREPLYREQUEST_PACKET_H
