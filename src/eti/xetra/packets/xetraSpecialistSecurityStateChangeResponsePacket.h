 ...
 */
#ifndef XETRA_SPECIALISTSECURITYSTATECHANGERESPONSE_PACKET_H
#define XETRA_SPECIALISTSECURITYSTATECHANGERESPONSE_PACKET_H
...
class xetraSpecialistSecurityStateChangeResponsePacket
{
    public:
        // no value constants
        ...
        // constructor
        xetraSpecialistSecurityStateChangeResponsePacket ()
        {
            mMessageHeaderOut.mTemplateID = 10318;
        ...
        {
            stringstream sss;
            sss << "SpecialistSecurityStateChangeResponse::"
...
const uint64_t xetraSpecialistSecurityStateChangeResponsePacket::SECURITY_STATUS_REPORT_ID_MIN = 0UL;
const uint64_t xetraSpecialistSecurityStateChangeResponsePacket::SECURITY_STATUS_REPORT_ID_MAX = 18446744073709551614UL;
const uint64_t xetraSpecialistSecurityStateChangeResponsePacket::SECURITY_STATUS_REPORT_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;


} // namespace neueda

#endif // XETRA_SPECIALISTSECURITYSTATECHANGERESPONSE_PACKET_H
