...
class xetraInquireUserRequestPacket
{
    public:
        // no value constants
...
const char xetraInquireUserRequestPacket::LAST_ENTITY_PROCESSED_NO_VALUE[16] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraInquireUserRequestPacket::LAST_ENTITY_PROCESSED_MAX_LENGTH = 16;


} // namespace neueda

#endif // XETRA_INQUIREUSERREQUEST_PACKET_H
