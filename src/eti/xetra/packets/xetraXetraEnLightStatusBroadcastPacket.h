 ...
 */
#ifndef XETRA_XETRAENLIGHTSTATUSBROADCAST_PACKET_H
#define XETRA_XETRAENLIGHTSTATUSBROADCAST_PACKET_H
...
class xetraXetraEnLightStatusBroadcastPacket
{
    public:
        // no value constants
        ...
        // constructor
        xetraXetraEnLightStatusBroadcastPacket ()
        {
            mMessageHeaderOut.mTemplateID = 10814;
        ...
        {
            stringstream sss;
            sss << "XetraEnLightStatusBroadcast::"
...
const int32_t xetraXetraEnLightStatusBroadcastPacket::TRADE_DATE_MIN = 0;
const int32_t xetraXetraEnLightStatusBroadcastPacket::TRADE_DATE_MAX = 99991231;
const int32_t xetraXetraEnLightStatusBroadcastPacket::TRADE_DATE_NO_VALUE = 0xFFFFFFFF;
const int8_t xetraXetraEnLightStatusBroadcastPacket::TRAD_SES_EVENT_MIN = 100;
const int8_t xetraXetraEnLightStatusBroadcastPacket::TRAD_SES_EVENT_MAX = 105;
const int8_t xetraXetraEnLightStatusBroadcastPacket::TRAD_SES_EVENT_NO_VALUE = 0xFF;
const char xetraXetraEnLightStatusBroadcastPacket::PAD3_NO_VALUE[3] = {0x00, 0x00, 0x00};
const size_t xetraXetraEnLightStatusBroadcastPacket::PAD3_MAX_LENGTH = 3;


} // namespace neueda

#endif // XETRA_XETRAENLIGHTSTATUSBROADCAST_PACKET_H
