...
class xetraNewOrderSingleShortRequestPacket
{
    public:
        // no value constants
...
const int64_t xetraNewOrderSingleShortRequestPacket::SECURITY_ID_MIN = -9223372036854775807L;
const int64_t xetraNewOrderSingleShortRequestPacket::SECURITY_ID_MAX = 9223372036854775807L;
const int64_t xetraNewOrderSingleShortRequestPacket::SECURITY_ID_NO_VALUE = 0x8000000000000000;
...
const uint64_t xetraNewOrderSingleShortRequestPacket::PARTY_IDCLIENT_ID_MIN = 0UL;
const uint64_t xetraNewOrderSingleShortRequestPacket::PARTY_IDCLIENT_ID_MAX = 18446744073709551614UL;
const uint64_t xetraNewOrderSingleShortRequestPacket::PARTY_IDCLIENT_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t xetraNewOrderSingleShortRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_MIN = 0UL;
const uint64_t xetraNewOrderSingleShortRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_MAX = 18446744073709551614UL;
const uint64_t xetraNewOrderSingleShortRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
...
const int16_t xetraNewOrderSingleShortRequestPacket::ENRICHMENT_RULE_ID_MIN = 1;
const int16_t xetraNewOrderSingleShortRequestPacket::ENRICHMENT_RULE_ID_MAX = 10000;
const int16_t xetraNewOrderSingleShortRequestPacket::ENRICHMENT_RULE_ID_NO_VALUE = 0xFFFF;
...
const int8_t xetraNewOrderSingleShortRequestPacket::VALUE_CHECK_TYPE_VALUE_MIN = 0;
const int8_t xetraNewOrderSingleShortRequestPacket::VALUE_CHECK_TYPE_VALUE_MAX = 1;
const int8_t xetraNewOrderSingleShortRequestPacket::VALUE_CHECK_TYPE_VALUE_NO_VALUE = 0xFF;
const int8_t xetraNewOrderSingleShortRequestPacket::VALUE_CHECK_TYPE_QUANTITY_MIN = 0;
const int8_t xetraNewOrderSingleShortRequestPacket::VALUE_CHECK_TYPE_QUANTITY_MAX = 1;
const int8_t xetraNewOrderSingleShortRequestPacket::VALUE_CHECK_TYPE_QUANTITY_NO_VALUE = 0xFF;
const int8_t xetraNewOrderSingleShortRequestPacket::ORDER_ATTRIBUTE_LIQUIDITY_PROVISION_MIN = 0;
const int8_t xetraNewOrderSingleShortRequestPacket::ORDER_ATTRIBUTE_LIQUIDITY_PROVISION_MAX = 1;
const int8_t xetraNewOrderSingleShortRequestPacket::ORDER_ATTRIBUTE_LIQUIDITY_PROVISION_NO_VALUE = 0xFF;
const int8_t xetraNewOrderSingleShortRequestPacket::TIME_IN_FORCE_MIN = 0;
const int8_t xetraNewOrderSingleShortRequestPacket::TIME_IN_FORCE_MAX = 6;
const int8_t xetraNewOrderSingleShortRequestPacket::TIME_IN_FORCE_NO_VALUE = 0xFF;
const int8_t xetraNewOrderSingleShortRequestPacket::EXEC_INST_MIN = 1;
const int8_t xetraNewOrderSingleShortRequestPacket::EXEC_INST_MAX = 6;
const int8_t xetraNewOrderSingleShortRequestPacket::EXEC_INST_NO_VALUE = 0xFF;
const int8_t xetraNewOrderSingleShortRequestPacket::TRADING_CAPACITY_MIN = 1;
const int8_t xetraNewOrderSingleShortRequestPacket::TRADING_CAPACITY_MAX = 9;
const int8_t xetraNewOrderSingleShortRequestPacket::TRADING_CAPACITY_NO_VALUE = 0xFF;
const int8_t xetraNewOrderSingleShortRequestPacket::EX_DESTINATION_TYPE_MIN = 3;
const int8_t xetraNewOrderSingleShortRequestPacket::EX_DESTINATION_TYPE_MAX = 3;
const int8_t xetraNewOrderSingleShortRequestPacket::EX_DESTINATION_TYPE_NO_VALUE = 0xFF;
const int8_t xetraNewOrderSingleShortRequestPacket::ORDER_ORIGINATION_MIN = 5;
const int8_t xetraNewOrderSingleShortRequestPacket::ORDER_ORIGINATION_MAX = 5;
const int8_t xetraNewOrderSingleShortRequestPacket::ORDER_ORIGINATION_NO_VALUE = 0xFF;
const int8_t xetraNewOrderSingleShortRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_MIN = 22;
const int8_t xetraNewOrderSingleShortRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_MAX = 24;
const int8_t xetraNewOrderSingleShortRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_NO_VALUE = 0xFF;
...
const char xetraNewOrderSingleShortRequestPacket::PAD5_NO_VALUE[5] = {0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraNewOrderSingleShortRequestPacket::PAD5_MAX_LENGTH = 5;


} // namespace neueda

#endif // XETRA_NEWORDERSINGLESHORTREQUEST_PACKET_H
