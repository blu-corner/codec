 ...
 */
#ifndef XETRA_RFQSPECIALISTBROADCAST_PACKET_H
#define XETRA_RFQSPECIALISTBROADCAST_PACKET_H
...
class xetraRFQSpecialistBroadcastPacket
{
    public:
        // no value constants
        ...
        // constructor
        xetraRFQSpecialistBroadcastPacket ()
        {
            mMessageHeaderOut.mTemplateID = 10419;
...
const int64_t xetraRFQSpecialistBroadcastPacket::SECURITY_ID_MIN = -9223372036854775807L;
const int64_t xetraRFQSpecialistBroadcastPacket::SECURITY_ID_MAX = 9223372036854775807L;
const int64_t xetraRFQSpecialistBroadcastPacket::SECURITY_ID_NO_VALUE = 0x8000000000000000;
const uint64_t xetraRFQSpecialistBroadcastPacket::EXEC_ID_MIN = 0UL;
const uint64_t xetraRFQSpecialistBroadcastPacket::EXEC_ID_MAX = 18446744073709551614UL;
const uint64_t xetraRFQSpecialistBroadcastPacket::EXEC_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const double xetraRFQSpecialistBroadcastPacket::ORDER_QTY_MIN = -922337203685477.5807;
const double xetraRFQSpecialistBroadcastPacket::ORDER_QTY_MAX = 922337203685477.5807;
const int64_t xetraRFQSpecialistBroadcastPacket::ORDER_QTY_NO_VALUE = 0x8000000000000000;
const uint64_t xetraRFQSpecialistBroadcastPacket::QUOTE_ID_MIN = 0UL;
const uint64_t xetraRFQSpecialistBroadcastPacket::QUOTE_ID_MAX = 18446744073709551614UL;
const uint64_t xetraRFQSpecialistBroadcastPacket::QUOTE_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const int32_t xetraRFQSpecialistBroadcastPacket::MARKET_SEGMENT_ID_MIN = -2147483647;
const int32_t xetraRFQSpecialistBroadcastPacket::MARKET_SEGMENT_ID_MAX = 2147483647;
const int32_t xetraRFQSpecialistBroadcastPacket::MARKET_SEGMENT_ID_NO_VALUE = 0x80000000;
const int8_t xetraRFQSpecialistBroadcastPacket::SIDE_MIN = 1;
const int8_t xetraRFQSpecialistBroadcastPacket::SIDE_MAX = 2;
const int8_t xetraRFQSpecialistBroadcastPacket::SIDE_NO_VALUE = 0xFF;
const char xetraRFQSpecialistBroadcastPacket::PARTY_EXECUTING_FIRM_NO_VALUE[5] = {0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraRFQSpecialistBroadcastPacket::PARTY_EXECUTING_FIRM_MAX_LENGTH = 5;
const char xetraRFQSpecialistBroadcastPacket::PAD6_NO_VALUE[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraRFQSpecialistBroadcastPacket::PAD6_MAX_LENGTH = 6;


} // namespace neueda

#endif // XETRA_RFQSPECIALISTBROADCAST_PACKET_H
