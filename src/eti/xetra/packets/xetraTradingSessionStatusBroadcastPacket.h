...
class xetraTradingSessionStatusBroadcastPacket
{
    public:
        // no value constants
        ...
        // constructor
        xetraTradingSessionStatusBroadcastPacket ()
        {
        ...
        codecState serialize (void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eti::serialize (mTradSesEvent, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eti::serialize (mRefApplLastMsgID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        codecState deserialize (const void *buf, size_t len, size_t &used)
        {
            ...
            if (state != GW_CODEC_SUCCESS) return state;
            state = eti::deserialize (mTradSesEvent, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eti::deserialize (mRefApplLastMsgID, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
...
const int32_t xetraTradingSessionStatusBroadcastPacket::MARKET_SEGMENT_ID_MIN = -2147483647;
const int32_t xetraTradingSessionStatusBroadcastPacket::MARKET_SEGMENT_ID_MAX = 2147483647;
const int32_t xetraTradingSessionStatusBroadcastPacket::MARKET_SEGMENT_ID_NO_VALUE = 0x80000000;
const int32_t xetraTradingSessionStatusBroadcastPacket::TRADE_DATE_MIN = 0;
const int32_t xetraTradingSessionStatusBroadcastPacket::TRADE_DATE_MAX = 99991231;
const int32_t xetraTradingSessionStatusBroadcastPacket::TRADE_DATE_NO_VALUE = 0xFFFFFFFF;
const int8_t xetraTradingSessionStatusBroadcastPacket::TRAD_SES_EVENT_MIN = 100;
const int8_t xetraTradingSessionStatusBroadcastPacket::TRAD_SES_EVENT_MAX = 105;
const int8_t xetraTradingSessionStatusBroadcastPacket::TRAD_SES_EVENT_NO_VALUE = 0xFF;
const char xetraTradingSessionStatusBroadcastPacket::REF_APPL_LAST_MSG_ID_NO_VALUE[16] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraTradingSessionStatusBroadcastPacket::REF_APPL_LAST_MSG_ID_MAX_LENGTH = 16;
const char xetraTradingSessionStatusBroadcastPacket::PAD7_NO_VALUE[7] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t xetraTradingSessionStatusBroadcastPacket::PAD7_MAX_LENGTH = 7;


} // namespace neueda

#endif // XETRA_TRADINGSESSIONSTATUSBROADCAST_PACKET_H
