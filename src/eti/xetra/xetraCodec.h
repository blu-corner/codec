...
class xetraCodec: public codec
{
    public:
        xetraCodec()
        {
            ...
            mMsgTypes.insert (std::make_pair ("10420", "RFQ Reject Notification"));
            mMsgTypes.insert (std::make_pair ("10401", "RFQ Request"));
            mMsgTypes.insert (std::make_pair ("10402", "RFQ Response"));
            mMsgTypes.insert (std::make_pair ("10419", "RFQ Specialist Broadcast"));
            ...
            mMsgTypes.insert (std::make_pair ("10418", "Single Quote Request"));
            mMsgTypes.insert (std::make_pair ("10137", "Specialist Delete All Order Broadcast"));
            mMsgTypes.insert (std::make_pair ("10319", "Specialist Instrument Event Notification"));
            mMsgTypes.insert (std::make_pair ("10136", "Specialist Order Book Notification"));
            mMsgTypes.insert (std::make_pair ("10421", "Specialist RFQ Reject Request"));
            mMsgTypes.insert (std::make_pair ("10424", "Specialist RFQ Reply Notification"));
            mMsgTypes.insert (std::make_pair ("10422", "Specialist RFQ Reply Request"));
            mMsgTypes.insert (std::make_pair ("10423", "Specialist RFQ Reply Response"));
            mMsgTypes.insert (std::make_pair ("10317", "Specialist Security State Change Request"));
            mMsgTypes.insert (std::make_pair ("10318", "Specialist Security State Change Response"));
    ...
    private:
        ...
        void getRFQRejectNotification (cdr& d, const void *buf, size_t len, size_t& used);
        ...
        void getRFQSpecialistBroadcast (cdr& d, const void *buf, size_t len, size_t& used);
        ...
        void getSingleQuoteRequest (cdr& d, const void *buf, size_t len, size_t& used);
        void getSpecialistDeleteAllOrderBroadcast (cdr& d, const void *buf, size_t len, size_t& used);
        void getSpecialistInstrumentEventNotification (cdr& d, const void *buf, size_t len, size_t& used);
        void getSpecialistOrderBookNotification (cdr& d, const void *buf, size_t len, size_t& used);
        void getSpecialistRFQRejectRequest (cdr& d, const void *buf, size_t len, size_t& used);
        void getSpecialistRFQReplyNotification (cdr& d, const void *buf, size_t len, size_t& used);
        void getSpecialistRFQReplyRequest (cdr& d, const void *buf, size_t len, size_t& used);
        void getSpecialistRFQReplyResponse (cdr& d, const void *buf, size_t len, size_t& used);
        void getSpecialistSecurityStateChangeRequest (cdr& d, const void *buf, size_t len, size_t& used);
        void getSpecialistSecurityStateChangeResponse (cdr& d, const void *buf, size_t len, size_t& used);
        ...
        void putRFQRejectNotification (const cdr& d, void *buf, size_t len, size_t& used);
        ...
        void putRFQSpecialistBroadcast (const cdr& d, void *buf, size_t len, size_t& used);
        ...
        void putSingleQuoteRequest (const cdr& d, void *buf, size_t len, size_t& used);
        void putSpecialistDeleteAllOrderBroadcast (const cdr& d, void *buf, size_t len, size_t& used);
        void putSpecialistInstrumentEventNotification (const cdr& d, void *buf, size_t len, size_t& used);
        void putSpecialistOrderBookNotification (const cdr& d, void *buf, size_t len, size_t& used);
        void putSpecialistRFQRejectRequest (const cdr& d, void *buf, size_t len, size_t& used);
        void putSpecialistRFQReplyNotification (const cdr& d, void *buf, size_t len, size_t& used);
        void putSpecialistRFQReplyRequest (const cdr& d, void *buf, size_t len, size_t& used);
        void putSpecialistRFQReplyResponse (const cdr& d, void *buf, size_t len, size_t& used);
        void putSpecialistSecurityStateChangeRequest (const cdr& d, void *buf, size_t len, size_t& used);
        void putSpecialistSecurityStateChangeResponse (const cdr& d, void *buf, size_t len, size_t& used);
