 ...
 */
#ifndef EUREX_NEWORDERCOMPLEXSHORTREQUEST_PACKET_H
#define EUREX_NEWORDERCOMPLEXSHORTREQUEST_PACKET_H
...
class eurexNewOrderComplexShortRequestPacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexNewOrderComplexShortRequestPacket ()
        {
            mMessageHeaderIn.mTemplateID = 10129;
        ...
        {
            stringstream sss;
            sss << "NewOrderComplexShortRequest::"
...
const int64_t eurexNewOrderComplexShortRequestPacket::SECURITY_ID_MIN = -9223372036854775807L;
const int64_t eurexNewOrderComplexShortRequestPacket::SECURITY_ID_MAX = 9223372036854775807L;
const int64_t eurexNewOrderComplexShortRequestPacket::SECURITY_ID_NO_VALUE = 0x8000000000000000;
const double eurexNewOrderComplexShortRequestPacket::PRICE_MIN = -92233720368.54775807;
const double eurexNewOrderComplexShortRequestPacket::PRICE_MAX = 92233720368.54775807;
const int64_t eurexNewOrderComplexShortRequestPacket::PRICE_NO_VALUE = 0x8000000000000000;
const double eurexNewOrderComplexShortRequestPacket::ORDER_QTY_MIN = -922337203685477.5807;
const double eurexNewOrderComplexShortRequestPacket::ORDER_QTY_MAX = 922337203685477.5807;
const int64_t eurexNewOrderComplexShortRequestPacket::ORDER_QTY_NO_VALUE = 0x8000000000000000;
const uint64_t eurexNewOrderComplexShortRequestPacket::CL_ORD_ID_MIN = 0UL;
const uint64_t eurexNewOrderComplexShortRequestPacket::CL_ORD_ID_MAX = 18446744073709551614UL;
const uint64_t eurexNewOrderComplexShortRequestPacket::CL_ORD_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexNewOrderComplexShortRequestPacket::PARTY_IDCLIENT_ID_MIN = 0UL;
const uint64_t eurexNewOrderComplexShortRequestPacket::PARTY_IDCLIENT_ID_MAX = 18446744073709551614UL;
const uint64_t eurexNewOrderComplexShortRequestPacket::PARTY_IDCLIENT_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexNewOrderComplexShortRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_MIN = 0UL;
const uint64_t eurexNewOrderComplexShortRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_MAX = 18446744073709551614UL;
const uint64_t eurexNewOrderComplexShortRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexNewOrderComplexShortRequestPacket::EXECUTING_TRADER_MIN = 0UL;
const uint64_t eurexNewOrderComplexShortRequestPacket::EXECUTING_TRADER_MAX = 18446744073709551614UL;
const uint64_t eurexNewOrderComplexShortRequestPacket::EXECUTING_TRADER_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const int32_t eurexNewOrderComplexShortRequestPacket::MARKET_SEGMENT_ID_MIN = -2147483647;
const int32_t eurexNewOrderComplexShortRequestPacket::MARKET_SEGMENT_ID_MAX = 2147483647;
const int32_t eurexNewOrderComplexShortRequestPacket::MARKET_SEGMENT_ID_NO_VALUE = 0x80000000;
const uint32_t eurexNewOrderComplexShortRequestPacket::MATCH_INST_CROSS_ID_MIN = 0;
const uint32_t eurexNewOrderComplexShortRequestPacket::MATCH_INST_CROSS_ID_MAX = 4294967294;
const uint32_t eurexNewOrderComplexShortRequestPacket::MATCH_INST_CROSS_ID_NO_VALUE = 0xFFFFFFFF;
const int16_t eurexNewOrderComplexShortRequestPacket::ENRICHMENT_RULE_ID_MIN = 1;
const int16_t eurexNewOrderComplexShortRequestPacket::ENRICHMENT_RULE_ID_MAX = 10000;
const int16_t eurexNewOrderComplexShortRequestPacket::ENRICHMENT_RULE_ID_NO_VALUE = 0xFFFF;
const int8_t eurexNewOrderComplexShortRequestPacket::APPL_SEQ_INDICATOR_MIN = 0;
const int8_t eurexNewOrderComplexShortRequestPacket::APPL_SEQ_INDICATOR_MAX = 1;
const int8_t eurexNewOrderComplexShortRequestPacket::APPL_SEQ_INDICATOR_NO_VALUE = 0xFF;
const int8_t eurexNewOrderComplexShortRequestPacket::PRODUCT_COMPLEX_MIN = 1;
const int8_t eurexNewOrderComplexShortRequestPacket::PRODUCT_COMPLEX_MAX = 10;
const int8_t eurexNewOrderComplexShortRequestPacket::PRODUCT_COMPLEX_NO_VALUE = 0xFF;
const int8_t eurexNewOrderComplexShortRequestPacket::SIDE_MIN = 1;
const int8_t eurexNewOrderComplexShortRequestPacket::SIDE_MAX = 2;
const int8_t eurexNewOrderComplexShortRequestPacket::SIDE_NO_VALUE = 0xFF;
const int8_t eurexNewOrderComplexShortRequestPacket::PRICE_VALIDITY_CHECK_TYPE_MIN = 0;
const int8_t eurexNewOrderComplexShortRequestPacket::PRICE_VALIDITY_CHECK_TYPE_MAX = 2;
const int8_t eurexNewOrderComplexShortRequestPacket::PRICE_VALIDITY_CHECK_TYPE_NO_VALUE = 0xFF;
const int8_t eurexNewOrderComplexShortRequestPacket::VALUE_CHECK_TYPE_VALUE_MIN = 0;
const int8_t eurexNewOrderComplexShortRequestPacket::VALUE_CHECK_TYPE_VALUE_MAX = 1;
const int8_t eurexNewOrderComplexShortRequestPacket::VALUE_CHECK_TYPE_VALUE_NO_VALUE = 0xFF;
const int8_t eurexNewOrderComplexShortRequestPacket::ORDER_ATTRIBUTE_LIQUIDITY_PROVISION_MIN = 0;
const int8_t eurexNewOrderComplexShortRequestPacket::ORDER_ATTRIBUTE_LIQUIDITY_PROVISION_MAX = 1;
const int8_t eurexNewOrderComplexShortRequestPacket::ORDER_ATTRIBUTE_LIQUIDITY_PROVISION_NO_VALUE = 0xFF;
const int8_t eurexNewOrderComplexShortRequestPacket::EXEC_INST_MIN = 1;
const int8_t eurexNewOrderComplexShortRequestPacket::EXEC_INST_MAX = 6;
const int8_t eurexNewOrderComplexShortRequestPacket::EXEC_INST_NO_VALUE = 0xFF;
const int8_t eurexNewOrderComplexShortRequestPacket::TIME_IN_FORCE_MIN = 0;
const int8_t eurexNewOrderComplexShortRequestPacket::TIME_IN_FORCE_MAX = 6;
const int8_t eurexNewOrderComplexShortRequestPacket::TIME_IN_FORCE_NO_VALUE = 0xFF;
const int8_t eurexNewOrderComplexShortRequestPacket::TRADING_CAPACITY_MIN = 1;
const int8_t eurexNewOrderComplexShortRequestPacket::TRADING_CAPACITY_MAX = 9;
const int8_t eurexNewOrderComplexShortRequestPacket::TRADING_CAPACITY_NO_VALUE = 0xFF;
const int8_t eurexNewOrderComplexShortRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_MIN = 22;
const int8_t eurexNewOrderComplexShortRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_MAX = 24;
const int8_t eurexNewOrderComplexShortRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_NO_VALUE = 0xFF;
const int8_t eurexNewOrderComplexShortRequestPacket::EXECUTING_TRADER_QUALIFIER_MIN = 22;
const int8_t eurexNewOrderComplexShortRequestPacket::EXECUTING_TRADER_QUALIFIER_MAX = 24;
const int8_t eurexNewOrderComplexShortRequestPacket::EXECUTING_TRADER_QUALIFIER_NO_VALUE = 0xFF;
const char eurexNewOrderComplexShortRequestPacket::PAD3_NO_VALUE[3] = {0x00, 0x00, 0x00};
const size_t eurexNewOrderComplexShortRequestPacket::PAD3_MAX_LENGTH = 3;


} // namespace neueda

#endif // EUREX_NEWORDERCOMPLEXSHORTREQUEST_PACKET_H
