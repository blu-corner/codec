 ...
 */
#ifndef EUREX_TESEXECUTIONBROADCAST_PACKET_H
#define EUREX_TESEXECUTIONBROADCAST_PACKET_H
...
class eurexTESExecutionBroadcastPacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexTESExecutionBroadcastPacket ()
        {
...
const uint64_t eurexTESExecutionBroadcastPacket::TRANSACT_TIME_MIN = 0UL;
const uint64_t eurexTESExecutionBroadcastPacket::TRANSACT_TIME_MAX = 18446744073709551614UL;
const uint64_t eurexTESExecutionBroadcastPacket::TRANSACT_TIME_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const int32_t eurexTESExecutionBroadcastPacket::MARKET_SEGMENT_ID_MIN = -2147483647;
const int32_t eurexTESExecutionBroadcastPacket::MARKET_SEGMENT_ID_MAX = 2147483647;
const int32_t eurexTESExecutionBroadcastPacket::MARKET_SEGMENT_ID_NO_VALUE = 0x80000000;
const uint32_t eurexTESExecutionBroadcastPacket::PACKAGE_ID_MIN = 0;
const uint32_t eurexTESExecutionBroadcastPacket::PACKAGE_ID_MAX = 4294967294;
const uint32_t eurexTESExecutionBroadcastPacket::PACKAGE_ID_NO_VALUE = 0xFFFFFFFF;
const uint32_t eurexTESExecutionBroadcastPacket::TESEXEC_ID_MIN = 0;
const uint32_t eurexTESExecutionBroadcastPacket::TESEXEC_ID_MAX = 4294967294;
const uint32_t eurexTESExecutionBroadcastPacket::TESEXEC_ID_NO_VALUE = 0xFFFFFFFF;
const uint32_t eurexTESExecutionBroadcastPacket::ALLOC_ID_MIN = 0;
const uint32_t eurexTESExecutionBroadcastPacket::ALLOC_ID_MAX = 4294967294;
const uint32_t eurexTESExecutionBroadcastPacket::ALLOC_ID_NO_VALUE = 0xFFFFFFFF;
const int16_t eurexTESExecutionBroadcastPacket::TRD_TYPE_MIN = 1;
const int16_t eurexTESExecutionBroadcastPacket::TRD_TYPE_MAX = 1010;
const int16_t eurexTESExecutionBroadcastPacket::TRD_TYPE_NO_VALUE = 0xFFFF;
const int8_t eurexTESExecutionBroadcastPacket::TRADE_REPORT_TYPE_MIN = 0;
const int8_t eurexTESExecutionBroadcastPacket::TRADE_REPORT_TYPE_MAX = 13;
const int8_t eurexTESExecutionBroadcastPacket::TRADE_REPORT_TYPE_NO_VALUE = 0xFF;
const int8_t eurexTESExecutionBroadcastPacket::SIDE_MIN = 1;
const int8_t eurexTESExecutionBroadcastPacket::SIDE_MAX = 2;
const int8_t eurexTESExecutionBroadcastPacket::SIDE_NO_VALUE = 0xFF;
const char eurexTESExecutionBroadcastPacket::MESSAGE_EVENT_SOURCE_NO_VALUE[1] = {0x00};
const size_t eurexTESExecutionBroadcastPacket::MESSAGE_EVENT_SOURCE_MAX_LENGTH = 1;
const char eurexTESExecutionBroadcastPacket::PAD3_NO_VALUE[3] = {0x00, 0x00, 0x00};
const size_t eurexTESExecutionBroadcastPacket::PAD3_MAX_LENGTH = 3;


} // namespace neueda

#endif // EUREX_TESEXECUTIONBROADCAST_PACKET_H
