 ...
 */
#ifndef EUREX_NEWORDERSINGLEREQUEST_PACKET_H
#define EUREX_NEWORDERSINGLEREQUEST_PACKET_H
...
class eurexNewOrderSingleRequestPacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexNewOrderSingleRequestPacket ()
        {
...
const double eurexNewOrderSingleRequestPacket::PRICE_MIN = -92233720368.54775807;
const double eurexNewOrderSingleRequestPacket::PRICE_MAX = 92233720368.54775807;
const int64_t eurexNewOrderSingleRequestPacket::PRICE_NO_VALUE = 0x8000000000000000;
const double eurexNewOrderSingleRequestPacket::ORDER_QTY_MIN = -922337203685477.5807;
const double eurexNewOrderSingleRequestPacket::ORDER_QTY_MAX = 922337203685477.5807;
const int64_t eurexNewOrderSingleRequestPacket::ORDER_QTY_NO_VALUE = 0x8000000000000000;
const double eurexNewOrderSingleRequestPacket::STOP_PX_MIN = -92233720368.54775807;
const double eurexNewOrderSingleRequestPacket::STOP_PX_MAX = 92233720368.54775807;
const int64_t eurexNewOrderSingleRequestPacket::STOP_PX_NO_VALUE = 0x8000000000000000;
const uint64_t eurexNewOrderSingleRequestPacket::CL_ORD_ID_MIN = 0UL;
const uint64_t eurexNewOrderSingleRequestPacket::CL_ORD_ID_MAX = 18446744073709551614UL;
const uint64_t eurexNewOrderSingleRequestPacket::CL_ORD_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexNewOrderSingleRequestPacket::PARTY_IDCLIENT_ID_MIN = 0UL;
const uint64_t eurexNewOrderSingleRequestPacket::PARTY_IDCLIENT_ID_MAX = 18446744073709551614UL;
const uint64_t eurexNewOrderSingleRequestPacket::PARTY_IDCLIENT_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexNewOrderSingleRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_MIN = 0UL;
const uint64_t eurexNewOrderSingleRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_MAX = 18446744073709551614UL;
const uint64_t eurexNewOrderSingleRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const uint64_t eurexNewOrderSingleRequestPacket::EXECUTING_TRADER_MIN = 0UL;
const uint64_t eurexNewOrderSingleRequestPacket::EXECUTING_TRADER_MAX = 18446744073709551614UL;
const uint64_t eurexNewOrderSingleRequestPacket::EXECUTING_TRADER_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const int32_t eurexNewOrderSingleRequestPacket::EXPIRE_DATE_MIN = 0;
const int32_t eurexNewOrderSingleRequestPacket::EXPIRE_DATE_MAX = 99991231;
const int32_t eurexNewOrderSingleRequestPacket::EXPIRE_DATE_NO_VALUE = 0xFFFFFFFF;
const int32_t eurexNewOrderSingleRequestPacket::MARKET_SEGMENT_ID_MIN = -2147483647;
const int32_t eurexNewOrderSingleRequestPacket::MARKET_SEGMENT_ID_MAX = 2147483647;
const int32_t eurexNewOrderSingleRequestPacket::MARKET_SEGMENT_ID_NO_VALUE = 0x80000000;
const uint32_t eurexNewOrderSingleRequestPacket::SIMPLE_SECURITY_ID_MIN = 0;
const uint32_t eurexNewOrderSingleRequestPacket::SIMPLE_SECURITY_ID_MAX = 4294967294;
const uint32_t eurexNewOrderSingleRequestPacket::SIMPLE_SECURITY_ID_NO_VALUE = 0xFFFFFFFF;
const uint32_t eurexNewOrderSingleRequestPacket::MATCH_INST_CROSS_ID_MIN = 0;
const uint32_t eurexNewOrderSingleRequestPacket::MATCH_INST_CROSS_ID_MAX = 4294967294;
const uint32_t eurexNewOrderSingleRequestPacket::MATCH_INST_CROSS_ID_NO_VALUE = 0xFFFFFFFF;
const char eurexNewOrderSingleRequestPacket::PARTY_IDTAKE_UP_TRADING_FIRM_NO_VALUE[5] = {0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexNewOrderSingleRequestPacket::PARTY_IDTAKE_UP_TRADING_FIRM_MAX_LENGTH = 5;
const char eurexNewOrderSingleRequestPacket::PARTY_IDORDER_ORIGINATION_FIRM_NO_VALUE[7] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexNewOrderSingleRequestPacket::PARTY_IDORDER_ORIGINATION_FIRM_MAX_LENGTH = 7;
const char eurexNewOrderSingleRequestPacket::PARTY_IDBENEFICIARY_NO_VALUE[9] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexNewOrderSingleRequestPacket::PARTY_IDBENEFICIARY_MAX_LENGTH = 9;
const int8_t eurexNewOrderSingleRequestPacket::APPL_SEQ_INDICATOR_MIN = 0;
const int8_t eurexNewOrderSingleRequestPacket::APPL_SEQ_INDICATOR_MAX = 1;
const int8_t eurexNewOrderSingleRequestPacket::APPL_SEQ_INDICATOR_NO_VALUE = 0xFF;
const int8_t eurexNewOrderSingleRequestPacket::SIDE_MIN = 1;
const int8_t eurexNewOrderSingleRequestPacket::SIDE_MAX = 2;
const int8_t eurexNewOrderSingleRequestPacket::SIDE_NO_VALUE = 0xFF;
const int8_t eurexNewOrderSingleRequestPacket::ORD_TYPE_MIN = 1;
const int8_t eurexNewOrderSingleRequestPacket::ORD_TYPE_MAX = 4;
const int8_t eurexNewOrderSingleRequestPacket::ORD_TYPE_NO_VALUE = 0xFF;
const int8_t eurexNewOrderSingleRequestPacket::PRICE_VALIDITY_CHECK_TYPE_MIN = 0;
const int8_t eurexNewOrderSingleRequestPacket::PRICE_VALIDITY_CHECK_TYPE_MAX = 2;
const int8_t eurexNewOrderSingleRequestPacket::PRICE_VALIDITY_CHECK_TYPE_NO_VALUE = 0xFF;
const int8_t eurexNewOrderSingleRequestPacket::VALUE_CHECK_TYPE_VALUE_MIN = 0;
const int8_t eurexNewOrderSingleRequestPacket::VALUE_CHECK_TYPE_VALUE_MAX = 1;
const int8_t eurexNewOrderSingleRequestPacket::VALUE_CHECK_TYPE_VALUE_NO_VALUE = 0xFF;
const int8_t eurexNewOrderSingleRequestPacket::ORDER_ATTRIBUTE_LIQUIDITY_PROVISION_MIN = 0;
const int8_t eurexNewOrderSingleRequestPacket::ORDER_ATTRIBUTE_LIQUIDITY_PROVISION_MAX = 1;
const int8_t eurexNewOrderSingleRequestPacket::ORDER_ATTRIBUTE_LIQUIDITY_PROVISION_NO_VALUE = 0xFF;
const int8_t eurexNewOrderSingleRequestPacket::ORDER_ATTRIBUTE_RISK_REDUCTION_MIN = 0;
const int8_t eurexNewOrderSingleRequestPacket::ORDER_ATTRIBUTE_RISK_REDUCTION_MAX = 1;
const int8_t eurexNewOrderSingleRequestPacket::ORDER_ATTRIBUTE_RISK_REDUCTION_NO_VALUE = 0xFF;
const int8_t eurexNewOrderSingleRequestPacket::TIME_IN_FORCE_MIN = 0;
const int8_t eurexNewOrderSingleRequestPacket::TIME_IN_FORCE_MAX = 6;
const int8_t eurexNewOrderSingleRequestPacket::TIME_IN_FORCE_NO_VALUE = 0xFF;
const int8_t eurexNewOrderSingleRequestPacket::EXEC_INST_MIN = 1;
const int8_t eurexNewOrderSingleRequestPacket::EXEC_INST_MAX = 6;
const int8_t eurexNewOrderSingleRequestPacket::EXEC_INST_NO_VALUE = 0xFF;
const int8_t eurexNewOrderSingleRequestPacket::TRADING_SESSION_SUB_ID_MIN = 1;
const int8_t eurexNewOrderSingleRequestPacket::TRADING_SESSION_SUB_ID_MAX = 8;
const int8_t eurexNewOrderSingleRequestPacket::TRADING_SESSION_SUB_ID_NO_VALUE = 0xFF;
const int8_t eurexNewOrderSingleRequestPacket::TRADING_CAPACITY_MIN = 1;
const int8_t eurexNewOrderSingleRequestPacket::TRADING_CAPACITY_MAX = 9;
const int8_t eurexNewOrderSingleRequestPacket::TRADING_CAPACITY_NO_VALUE = 0xFF;
const int8_t eurexNewOrderSingleRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_MIN = 22;
const int8_t eurexNewOrderSingleRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_MAX = 24;
const int8_t eurexNewOrderSingleRequestPacket::PARTY_ID_INVESTMENT_DECISION_MAKER_QUALIFIER_NO_VALUE = 0xFF;
const int8_t eurexNewOrderSingleRequestPacket::EXECUTING_TRADER_QUALIFIER_MIN = 22;
const int8_t eurexNewOrderSingleRequestPacket::EXECUTING_TRADER_QUALIFIER_MAX = 24;
const int8_t eurexNewOrderSingleRequestPacket::EXECUTING_TRADER_QUALIFIER_NO_VALUE = 0xFF;
const char eurexNewOrderSingleRequestPacket::ACCOUNT_NO_VALUE[2] = {0x00, 0x00};
const size_t eurexNewOrderSingleRequestPacket::ACCOUNT_MAX_LENGTH = 2;
const char eurexNewOrderSingleRequestPacket::PARTY_IDPOSITION_ACCOUNT_NO_VALUE[32] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexNewOrderSingleRequestPacket::PARTY_IDPOSITION_ACCOUNT_MAX_LENGTH = 32;
const char eurexNewOrderSingleRequestPacket::POSITION_EFFECT_NO_VALUE[1] = {0x00};
const size_t eurexNewOrderSingleRequestPacket::POSITION_EFFECT_MAX_LENGTH = 1;
const char eurexNewOrderSingleRequestPacket::PARTY_IDLOCATION_ID_NO_VALUE[2] = {0x00, 0x00};
const size_t eurexNewOrderSingleRequestPacket::PARTY_IDLOCATION_ID_MAX_LENGTH = 2;
const char eurexNewOrderSingleRequestPacket::CUST_ORDER_HANDLING_INST_NO_VALUE[1] = {0x00};
const size_t eurexNewOrderSingleRequestPacket::CUST_ORDER_HANDLING_INST_MAX_LENGTH = 1;
const char eurexNewOrderSingleRequestPacket::COMPLIANCE_TEXT_NO_VALUE[20] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexNewOrderSingleRequestPacket::COMPLIANCE_TEXT_MAX_LENGTH = 20;
const char eurexNewOrderSingleRequestPacket::FREE_TEXT1_NO_VALUE[12] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexNewOrderSingleRequestPacket::FREE_TEXT1_MAX_LENGTH = 12;
const char eurexNewOrderSingleRequestPacket::FREE_TEXT2_NO_VALUE[12] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexNewOrderSingleRequestPacket::FREE_TEXT2_MAX_LENGTH = 12;
const char eurexNewOrderSingleRequestPacket::FREE_TEXT3_NO_VALUE[12] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexNewOrderSingleRequestPacket::FREE_TEXT3_MAX_LENGTH = 12;
const char eurexNewOrderSingleRequestPacket::FIXCL_ORD_ID_NO_VALUE[20] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexNewOrderSingleRequestPacket::FIXCL_ORD_ID_MAX_LENGTH = 20;
const char eurexNewOrderSingleRequestPacket::PAD4_NO_VALUE[4] = {0x00, 0x00, 0x00, 0x00};
const size_t eurexNewOrderSingleRequestPacket::PAD4_MAX_LENGTH = 4;


} // namespace neueda

#endif // EUREX_NEWORDERSINGLEREQUEST_PACKET_H
