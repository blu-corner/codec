...
class eurexInstrumentAttributeGrpCompPacket
{
    public:
        ...
        {
            codecState state;
            state = eti::serialize (mInstrAttribType, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eti::serialize (mInstrAttribValue, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
        ...
        {
            codecState state;
            state = eti::deserialize (mInstrAttribType, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
            state = eti::deserialize (mInstrAttribValue, buf, len, used);
            if (state != GW_CODEC_SUCCESS) return state;
