 ...
 */
#ifndef EUREX_QUOTEENTRYGRPCOMP_PACKET_H
#define EUREX_QUOTEENTRYGRPCOMP_PACKET_H
...
class eurexQuoteEntryGrpCompPacket
{
    public:
        // no value constants
...
const int64_t eurexQuoteEntryGrpCompPacket::SECURITY_ID_MIN = -9223372036854775807L;
const int64_t eurexQuoteEntryGrpCompPacket::SECURITY_ID_MAX = 9223372036854775807L;
const int64_t eurexQuoteEntryGrpCompPacket::SECURITY_ID_NO_VALUE = 0x8000000000000000;
const double eurexQuoteEntryGrpCompPacket::BID_PX_MIN = -92233720368.54775807;
const double eurexQuoteEntryGrpCompPacket::BID_PX_MAX = 92233720368.54775807;
const int64_t eurexQuoteEntryGrpCompPacket::BID_PX_NO_VALUE = 0x8000000000000000;
const double eurexQuoteEntryGrpCompPacket::BID_SIZE_MIN = -922337203685477.5807;
const double eurexQuoteEntryGrpCompPacket::BID_SIZE_MAX = 922337203685477.5807;
const int64_t eurexQuoteEntryGrpCompPacket::BID_SIZE_NO_VALUE = 0x8000000000000000;
const double eurexQuoteEntryGrpCompPacket::OFFER_PX_MIN = -92233720368.54775807;
const double eurexQuoteEntryGrpCompPacket::OFFER_PX_MAX = 92233720368.54775807;
const int64_t eurexQuoteEntryGrpCompPacket::OFFER_PX_NO_VALUE = 0x8000000000000000;
const double eurexQuoteEntryGrpCompPacket::OFFER_SIZE_MIN = -922337203685477.5807;
const double eurexQuoteEntryGrpCompPacket::OFFER_SIZE_MAX = 922337203685477.5807;
const int64_t eurexQuoteEntryGrpCompPacket::OFFER_SIZE_NO_VALUE = 0x8000000000000000;


} // namespace neueda

#endif // EUREX_QUOTEENTRYGRPCOMP_PACKET_H
