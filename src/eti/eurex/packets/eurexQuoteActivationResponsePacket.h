 ...
 */
#ifndef EUREX_QUOTEACTIVATIONRESPONSE_PACKET_H
#define EUREX_QUOTEACTIVATIONRESPONSE_PACKET_H
...
class eurexQuoteActivationResponsePacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexQuoteActivationResponsePacket ()
        {
...
const uint64_t eurexQuoteActivationResponsePacket::MASS_ACTION_REPORT_ID_MIN = 0UL;
const uint64_t eurexQuoteActivationResponsePacket::MASS_ACTION_REPORT_ID_MAX = 18446744073709551614UL;
const uint64_t eurexQuoteActivationResponsePacket::MASS_ACTION_REPORT_ID_NO_VALUE = 0xFFFFFFFFFFFFFFFF;
const int16_t eurexQuoteActivationResponsePacket::NO_NOT_AFFECTED_SECURITIES_MIN = 0;
const int16_t eurexQuoteActivationResponsePacket::NO_NOT_AFFECTED_SECURITIES_MAX = 500;
const int16_t eurexQuoteActivationResponsePacket::NO_NOT_AFFECTED_SECURITIES_NO_VALUE = 0xFFFF;
const char eurexQuoteActivationResponsePacket::PAD6_NO_VALUE[6] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexQuoteActivationResponsePacket::PAD6_MAX_LENGTH = 6;
const size_t eurexQuoteActivationResponsePacket::NOT_AFFECTED_SECURITIES_GRP_MIN = 0;
const size_t eurexQuoteActivationResponsePacket::NOT_AFFECTED_SECURITIES_GRP_MAX = 500;


} // namespace neueda

#endif // EUREX_QUOTEACTIVATIONRESPONSE_PACKET_H
