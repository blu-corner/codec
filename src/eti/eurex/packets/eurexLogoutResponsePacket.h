 ...
 */
#ifndef EUREX_LOGOUTRESPONSE_PACKET_H
#define EUREX_LOGOUTRESPONSE_PACKET_H
...
class eurexLogoutResponsePacket
{
    public:
        // no value constants
...
#endif // EUREX_LOGOUTRESPONSE_PACKET_H
