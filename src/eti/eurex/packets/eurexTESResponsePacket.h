 ...
 */
#ifndef EUREX_TESRESPONSE_PACKET_H
#define EUREX_TESRESPONSE_PACKET_H
...
const uint32_t eurexTESResponsePacket::TESEXEC_ID_MIN = 0;
const uint32_t eurexTESResponsePacket::TESEXEC_ID_MAX = 4294967294;
const uint32_t eurexTESResponsePacket::TESEXEC_ID_NO_VALUE = 0xFFFFFFFF;
const char eurexTESResponsePacket::TRADE_REPORT_ID_NO_VALUE[20] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
const size_t eurexTESResponsePacket::TRADE_REPORT_ID_MAX_LENGTH = 20;


} // namespace neueda

#endif // EUREX_TESRESPONSE_PACKET_H
