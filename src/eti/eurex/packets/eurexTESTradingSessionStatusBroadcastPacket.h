 ...
 */
#ifndef EUREX_TESTRADINGSESSIONSTATUSBROADCAST_PACKET_H
#define EUREX_TESTRADINGSESSIONSTATUSBROADCAST_PACKET_H
...
class eurexTESTradingSessionStatusBroadcastPacket
{
    public:
        // no value constants
        ...
        // constructor
        eurexTESTradingSessionStatusBroadcastPacket ()
        {
...
const int32_t eurexTESTradingSessionStatusBroadcastPacket::TRADE_DATE_MIN = 0;
const int32_t eurexTESTradingSessionStatusBroadcastPacket::TRADE_DATE_MAX = 99991231;
const int32_t eurexTESTradingSessionStatusBroadcastPacket::TRADE_DATE_NO_VALUE = 0xFFFFFFFF;
const int8_t eurexTESTradingSessionStatusBroadcastPacket::TRAD_SES_EVENT_MIN = 100;
const int8_t eurexTESTradingSessionStatusBroadcastPacket::TRAD_SES_EVENT_MAX = 105;
const int8_t eurexTESTradingSessionStatusBroadcastPacket::TRAD_SES_EVENT_NO_VALUE = 0xFF;
const char eurexTESTradingSessionStatusBroadcastPacket::PAD3_NO_VALUE[3] = {0x00, 0x00, 0x00};
const size_t eurexTESTradingSessionStatusBroadcastPacket::PAD3_MAX_LENGTH = 3;


} // namespace neueda

#endif // EUREX_TESTRADINGSESSIONSTATUSBROADCAST_PACKET_H
