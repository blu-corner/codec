...
"\
Usage:\n\
   flieReader [options] codec files...\n\
\n\
Description:\n\
   Utility that decodes a binary file using the specified codec.\n\
\n\
Options:\n\
   -f   Binary file to decode.\n\
   -v   Codec venue.\n\
   -h   Displays this help and exists.\n\
\n\
Examples:\n\
   >> fileReader -v lse -f messages.in\n\
";
...
int main (int argc, char** argv)
{
    ...
    while (offset < size)
    {
        ...
        std::cout << std::endl << neueda::codec::prettyPrintCdr (cdr)
                  << std::endl;
        offset += used;
    }
